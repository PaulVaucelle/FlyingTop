...
//  gROOT->ProcessLine(".L TreeABCDReader.C+");
  ...
  TString ProdEMU = "DATA_EMU_2024_23_04_2025"; // "DATA_MUMU_2018_19_08_2024"; // "DATA_EMU_2018_19_08_2024";
  int YEAR = 2024;
...
//  // Data 
  ...
  TString BKGSetEMU[1]={ "MuonEG_Run2024"
  };
   ...
   for (int i = 0 ; i< 1 ; i++) 
    {
      ...
      t->Loop(isMC, ProdEMU, BKGSetEMU[i],false, SameSign, Forward, YEAR, mean, false, mixing, 0, isPostAPV,systlist[0],CorrectCorrelation);
      delete t;
    }
