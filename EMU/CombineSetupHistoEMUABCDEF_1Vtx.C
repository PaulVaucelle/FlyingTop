...
TString ProdData                = "DATA_MUMU_"+YEAR+"_19_08_2024";
    ...
    TString htitleC = "hData_CRlowpt_"+nVtx+"_"+Variable;
    TString htitleD = "hData_CRlooselowpt_"+nVtx+"_"+Variable;//

    TString htitleE = "hData_Hemi_"+nVtx+"_"+Variable;//
    TString htitleF = "hData_CRloose_"+nVtx+"_"+Variable;//


    // !!  Name of the output file (that will be an input of the datacards)
    std::vector<TString> REGIONS = {

        "TightTight_LowLowPT_1Vtx_control_region",    //A
        "LooseLoose_LowLowPT_1Vtx_control_region",   //B

        "TightTight_HighLowPT_1Vtx_signal_region",    //C
        "LooseLoose_HighLowPT_1Vtx_control_region",   //D

        "TightTight_HighHighPT_1Vtx_signal_region",    //E
        "LooseLoose_HighHighPT_1Vtx_control_region",   //F
        ...
        for (unsigned int i = 0 ; i < REGIONS.size() ; i++) // There are 9 regions to loop over for the 2 Vtx category : ABCDEFGHI ( 2Vtx and 2VtxAll )
            {
                                ...
                                for (unsigned int l = 0 ; l < 34 ; l++) // loop over the signal samples
                                    {
                                        ...
                                        htitleC = shortname+"_hData_CRlowpt_"+nVtx+"_"+Variable+"_";
                                        htitleD = shortname+"_hData_CRlooselowpt_"+nVtx+"_"+Variable+"_";

                                        htitleE = shortname+"_hData_Hemi_"+nVtx+"_"+Variable+"_";
                                        htitleF = shortname+"_hData_CRloose_"+nVtx+"_"+Variable+"_";
                ...
                int returnCode = gSystem->Exec("mv "+outputFileName+" /opt/sbg/cms/ui2_data1/pvaucell/CMSSW_11_3_4/src/HiggsAnalysis/CombinedLimit/data/RPV_UDD_"+YEAR+"/ABCDEF_"+Channel+"_"+MU+"_"+Sign+"_"+etamax+"_"+nVtx+"/ ");
