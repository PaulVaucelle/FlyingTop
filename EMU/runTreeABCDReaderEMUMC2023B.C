...
//  gROOT->ProcessLine(".L TreeABCDReader.C+");
  ...
  int YEAR = 2023;
  TString Prod = "MC_EMU_2023_D_23_04_2025"; //DATAMC2018_EMU_10_06_2024 //  EMU: SYST_EMU_CTAU100/Prod100_EMU_JER_up !! M: SYST_CTAU100/Prod100_JER_up // BKG MC and Data PROD_ANNIVERSAIRE_2024
  bool isPostAPV = true;
  bool Signal = false;
  bool SameSign = false;
  bool Forward = false; 
   ...
   for (int i = 2 ; i< 9 ; i++) 
    {
      for (unsigned int j = 0 ; j < systlist.size(); j++)
        {
              Prod = "MC_EMU_2023_D_23_04_2025";
              if (systlist.size() == 0) return;
              else if (systlist[j] == "JECUp")
                {
                  Prod = "MC_EMU_2023_D_23_04_2025_JECUp";
                }
              else if (systlist[j] == "JECDown")
                {
                  Prod = "MC_EMU_2023_D_23_04_2025_JECDown";
                }
              else if (systlist[j] == "JERUp")
                {
                  Prod = "MC_EMU_2023_D_23_04_2025_JERUp";
                }
              else if (systlist[j] == "JERDown")
                {
                  Prod = "MC_EMU_2023_D_23_04_2025_JERDown";
                }
              else
                {
                  Prod = "MC_EMU_2023_D_23_04_2025";
