...
void GatherHistograms() {
    ...
    TString Channel = "EMU";// MUMU ou EMU
    ...
    std::vector<TString> ProdSignalSyst = {
        ProdSignal, 
        ProdSignalLumiUp, ProdSignalLumiDown, 
        ProdSignalXSUp, ProdSignalXSDown, 
        ProdSignalJECUp, ProdSignalJECDown, 
        ProdSignalJERUp, ProdSignalJERDown
        };
    ...
    if (Channel == "EMU")
        {
            DataSet[0] = "MuonEG-UL2018_MiniAODv2_GT36-v1";
    ...
    TString htitleA = "hData_CRlowlowpt_"+nVtx+"_"+Variable;
    TString htitleB = "hData_CRlowlowpt_"+AltVtx+"_"+Variable;
    TString htitleC = "hData_CRlooselowlowpt_"+nVtx+"_"+Variable;

    TString htitleD = "hData_CRlowpt_"+nVtx+"_"+Variable;
    TString htitleE = "hData_CRlowpt_"+AltVtx+"_"+Variable;//
    TString htitleF = "hData_CRlooselowpt_"+nVtx+"_"+Variable;//

    TString htitleG = "hData_Hemi_"+nVtx+"_"+Variable;//
    TString htitleH = "hData_Hemi_"+AltVtx+"_"+Variable;//
    TString htitleI = "hData_CRloose_"+nVtx+"_"+Variable;//


    // !!  Name of the output file (that will be an input of the datacards so do not change the name)
    std::vector<TString> REGIONS = {

        "TightTight_LowLowPT_2Vtx_control_region",    //A
        "TightLoose_LowLowPT_2Vtx_control_region",   //B
        "LooseLoose_LowLowPT_2Vtx_control_region",   //C

        "TightTight_HighLowPT_2Vtx_signal_region",    //D
        "TightLoose_HighLowPT_2Vtx_signal_region",   //E
        "LooseLoose_HighLowPT_2Vtx_control_region",   //F

        "TightTight_HighHighPT_2Vtx_signal_region",    //G
        "TightLoose_HighHighPT_2Vtx_signal_region",   //H
        "LooseLoose_HighHighPT_2Vtx_control_region",   //I
        ...
        for (unsigned int i = 0 ; i < REGIONS.size() ; i++) // There are 9 regions to loop over for the 2 Vtx category : ABCDEFGHI ( 2Vtx and 2VtxAll )
            {
                ...
                //                 htitleA = shortname+"_hData_CRlowlowpt_"+nVtx+"_"+Variable+"_";
                //                 htitleB = shortname+"_hData_CRlowlowpt_"+AltVtx+"_"+Variable+"_";
                //                 htitleC = shortname+"_hData_CRlooselowlowpt_"+nVtx+"_"+Variable+"_";
                                
                //                 htitleD = shortname+"_hData_CRlowpt_"+nVtx+"_"+Variable+"_";
                //                 htitleE = shortname+"_hData_CRlowpt_"+AltVtx+"_"+Variable+"_";
                //                 htitleF = shortname+"_hData_CRlooselowpt_"+nVtx+"_"+Variable+"_";

                //                 htitleG = shortname+"_hData_Hemi_"+nVtx+"_"+Variable+"_";
                //                 htitleH = shortname+"_hData_Hemi_"+AltVtx+"_"+Variable+"_";
                //                 htitleI = shortname+"_hData_CRloose_"+nVtx+"_"+Variable+"_";
                ...
                int returnCode = gSystem->Exec("mv "+outputFileName+" /opt/sbg/cms/ui2_data1/pvaucell/CMSSW_11_3_4/src/HiggsAnalysis/CombinedLimit/data/RPV_UDD_"+YEAR+"/ABCDEFGHI_"+Channel+"_"+MU+"_"+Sign+"_"+etamax+"_"+nVtx+"/ ");
