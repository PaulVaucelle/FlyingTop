...
bool Signal = SIGNAL;
  ...
  float hmax = 200;	         // for eta<2.4 pt>80 or CRlowlowpt
  float hmaxBD = 1E4;	         // for eta<2.4 pt>80 or CRlowlowpt
  float ReScaleXS = 1.;
...
//Mumu
 TFile* f1_DY  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f2_DY  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f1_TT  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_TT  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f1_ST  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_tW_antitop_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_ST  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_tW_top_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f3_ST  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_t-channel_top_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f4_ST  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_t-channel_antitop_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f1_TTV = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_ttWJetsToLNu_5f_EWK_TuneCP5_13TeV_amcatnlo-pythia8.root");
 TFile* f2_TTV = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_TTZToLL_5f_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f3_TTV = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_TTWW_TuneCP5_13TeV-madgraph-pythia8.root");
 TFile* f1_VV  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_VV  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_WZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
 TFile* f3_VV  = new TFile("../../MC_EMU_2018_03_02_2025/histofile_"+Dmode+"_OS_2p4_ZZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
...
if (Method == 1)
  {
    ...
    HeaderC = "Tight";
    HeaderD = "Loose";
    HeaderAbis = "2 hemi., p_{T}<"+HTcut+"";
    HeaderCbis = ">= 1 hemi., p_{T} > "+HTcut+" GeV";
    HeaderBbis = "2 hemi., p_{T}<"+HTcut+"";
...
c2->cd();
  ...
  if (DATA)
  {
    ...
    if (DATA && !MC)
      {
        htotData->SetMinimum(1); 
        htotData->SetMaximum(htotDatav2->GetMaximum()*1.5); 
      }
    if (DATA && MC)
      {
        htotData->SetMinimum(1); 
        htotData->SetMaximum(htotData->GetMaximum()*1.5); //htotMC->GetMaximum()*1
      }
