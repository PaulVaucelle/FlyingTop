...
void TreeABCDReader::Loop(bool isMC, TString Prod, TString sample, bool Signal, bool SS, bool FWD, int Year, float mean, bool DoubleMuon, int mixing, int Channel,  bool isPostAPV, TString thesystlist, bool CorrectCorrelation)
{
  ...
  TString thesample  = sample;
   ...
   TString samplename = thesample;
     ...
     if( systlist== "") samplename = thesample;
      ...
      firstinit = true;
TString theoutputfileNAME = "histofile_HT100_"+CHANNEL+"_"+ADD_Text+"_"+samplename+"";
   if (CorrectCorrelation) {theoutputfileNAME = "histofile_HT100_"+CHANNEL+"_"+ADD_Text+"_"+samplename+"_Corr";}
   TFile * theoutputfile = new TFile( ("../../"+Prod+"/"+theoutputfileNAME+".root").Data() , "recreate");
   theoutputfile->cd();
...
Nevent = nentries;
   ...
   double nRecoLooseVertex = 0;
      ...
      double nRecoTightVertex1 = 0;
   double nRecoLooseVertex1 = 0;

      double nRecoTightVertex2 = 0;
   double nRecoLooseVertex2 = 0;
...
// !! new Vertex BDT 
   ...
   TString BDT_VTX_Name = "BDT_2VTX_2024_11_10_2025_TrainingvF_ctau100.xml";
   TString BDT_EVT2VTX_Name = "BDT_EVT2VTX_2024_11_10_2025_TrainingvF_ctau100.xml";

   if (Year == 2024)
      {
         BDT_VTX_Name = "BDT_2VTX_2024_11_10_2025_TrainingvF_ctau100.xml";
         BDT_EVT2VTX_Name = "BDT_EVT2VTX_2024_11_10_2025_TrainingvF_ctau100.xml";
      }
   else if (Year == 2023)
      {
         if (isPostAPV)
            {
               BDT_VTX_Name = "BDT_2VTX_2023POST_11_10_2025_TrainingvF_ctau100.xml";
               BDT_EVT2VTX_Name = "BDT_EVT2VTX_2023POST_11_10_2025_TrainingvF_ctau100.xml";
            }
         else
            {
               BDT_VTX_Name = "BDT_2VTX_2023PRE_11_10_2025_TrainingvF_ctau100.xml";
               BDT_EVT2VTX_Name = "BDT_EVT2VTX_2023PRE_11_10_2025_TrainingvF_ctau100.xml";
            }
      }
   else if (Year == 2022)
      {
         if (isPostAPV)
            {
               BDT_VTX_Name = "BDT_2VTX_2022POST_11_10_2025_TrainingvF_ctau100.xml";
               BDT_EVT2VTX_Name = "BDT_EVT2VTX_2022POST_11_10_2025_TrainingvF_ctau100.xml";
            }
         else
            {
               BDT_VTX_Name = "BDT_2VTX_2022PRE_11_10_2025_TrainingvF_ctau100.xml";
               BDT_EVT2VTX_Name = "BDT_EVT2VTX_2022PRE_11_10_2025_TrainingvF_ctau100.xml";
            }
      }
   readerVtx->BookMVA( "BDTG", "/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_14_0_20/src/FlyingTop/FlyingTop/test/"+BDT_VTX_Name); // root 6.14/09, care compatiblity of versions for tmva
// !! EMU training : /opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/BDT_2VTX_18_06_2025_TrainingvF_ctau100.xml
   // -----------------------
...
readerVtx_EVT->AddVariable( "mva_Vtx2_NChi2",   &mva_V2_chi);
   ...
   readerVtx_EVT->BookMVA( "BDTG", "/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_14_0_20/src/FlyingTop/FlyingTop/test/"+BDT_EVT2VTX_Name); // root 6.14/09, care compatiblity of versions for tmva
// !! Training EMU : /opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/BDT_EVT2VTX_18_06_2025_TrainingvF_ctau100_NoStep.xml
      ...
      // 2022A
      // ../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/lowpT/Run3_2022BCD_PreEEMC/passingRECO/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/midpT/Run3_2022BCD_New_midpT7/passingRECO/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/highpT/Run3_2022BCD_New_highpt6/passingRECO/egammaEffi.txt_EGM2D.root 

      // ../../Scale_factors/Ele_SF/Data2022/ForRe-recoBCD/tnpEleID/passingCutBasedTight122XV1/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2022/Trig_2022
      // 2022B

      // ../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/lowpT/Run3_2022EFG_PostEEMC/passingRECO/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/midpT/Run3_2022EFG_New_midpT5/passingRECO/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/highpT/Run3_2022EFG_New_highpt5/passingRECO/egammaEffi.txt_EGM2D.root 

      // ../../Scale_factors/Ele_SF/Data2022/ForRe-recoE+PromptFG/tnpEleID/passingCutBasedTight122XV1/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2022/Trig_2022
      // 2023C

      // ../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/lowpT/Run3_2023C_New_lowpT_mergeEta_Added_symmetrizationsystEta_29052024/passingRECO/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/midpT/Run3_2023C_New_midpT2_eta/passingRECO/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/highpT/Run3_2023C_New_highpt1_eta/passingRECO/egammaEffi.txt_EGM2D.root 

      // ../../Scale_factors/Ele_SF/Data2023/passingCutBasedTight122XV1/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2023/Trig_2023
      // 2023D
      // ../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/midpT/Run3_2023D_New_midpT_eta2/passingRECO/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/lowpT/Run3_2023D_New_lowpT_mergeEta_Added_symmetrizationsystEta_29052024/passingRECO/egammaEffi.txt_EGM2D.root
      // ../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/highpT/Run3_2023D_New_highpt_eta2/passingRECO/egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2023/passingCutBasedTight122XV1/Hole_egammaEffi.txt_EGM2D.root 
      // ../../Scale_factors/Ele_SF/Data2023/Trig_2023

     // Where L1 is always a muon and L2 is either a muon for the dimuon channel or a
   // an electron for the Emu channel
   // !! ------------------------------------
   TFile*            fL1_ID_SF= new TFile("../../Scale_factors/DisplacedTop2022/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
   TFile*           fL1_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2022/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");
   TFile*           fL2_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2022/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");
   // !!--------------------------------------
   TFile*           fL2_Reco_SF_low= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/lowpT/Run3_2022BCD_PreEEMC/passingRECO/egammaEffi.txt_EGM2D.root");
   TFile*           fL2_Reco_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/midpT/Run3_2022BCD_New_midpT7/passingRECO/egammaEffi.txt_EGM2D.root ");
   TFile*           fL2_Reco_SF2= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/highpT/Run3_2022BCD_New_highpt6/passingRECO/egammaEffi.txt_EGM2D.root");
   // !! ------------------------------------
   TFile*            fL2_ID_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/ForRe-recoBCD/tnpEleID/passingCutBasedTight122XV1/egammaEffi.txt_EGM2D.root");
   // !! ------------------------------------
   TFile*            fL1L2_TRG_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/Trig_2022/trigSF_2D.root");    
   TFile*            fL1L2_TRG_SFerr = new TFile("../../Scale_factors/Ele_SF/Data2022/Trig_2022/trigSF_2Derr.root");
   ...
   if (MuMu == 0 && isMC)
      {
         if (Year == 2024)
            {
                  ...
                  fL1_ID_SF= new TFile("../../Scale_factors/DisplacedTop2023_Bpix/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL1_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2023_Bpix/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");
                  // !!--------------------------------------
                  fL2_Reco_SF_low= new TFile("../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/lowpT/Run3_2023D_New_lowpT_mergeEta_Added_symmetrizationsystEta_29052024/passingRECO/egammaEffi.txt_EGM2D.root");
                  fL2_Reco_SF= new TFile("../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/midpT/Run3_2023D_New_midpT_eta2/passingRECO/egammaEffi.txt_EGM2D.root");
                  fL2_Reco_SF2= new TFile("../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/highpT/Run3_2023D_New_highpt_eta2/passingRECO/egammaEffi.txt_EGM2D.root ");
                  // !! ------------------------------------
                  fL2_ID_SF= new TFile("../../Scale_factors/Ele_SF/Data2023/passingCutBasedTight122XV1/Hole_egammaEffi.txt_EGM2D.root");
                  // !! ------------------------------------
                  fL1L2_TRG_SF= new TFile("../../Scale_factors/Ele_SF/Data2023/Trig_2023/trigSF_2D.root");    
                  fL1L2_TRG_SFerr = new TFile("../../Scale_factors/Ele_SF/Data2023/Trig_2023/trigSF_2Derr.root");
         ...
         if(Year == 2023)
            {
               if (isPostAPV){
                  ...
                  fL1_ID_SF= new TFile("../../Scale_factors/DisplacedTop2023/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL1_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2023/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

                  // !!--------------------------------------
                  fL2_Reco_SF_low= new TFile("../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/lowpT/Run3_2023C_New_lowpT_mergeEta_Added_symmetrizationsystEta_29052024/passingRECO/egammaEffi.txt_EGM2D.root");
                  fL2_Reco_SF= new TFile("../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/midpT/Run3_2023C_New_midpT2_eta/passingRECO/egammaEffi.txt_EGM2D.root");
                  fL2_Reco_SF2= new TFile("../../Scale_factors/Ele_SF/Data2023/SF_prompt_2023_19012024/highpT/Run3_2023C_New_highpt1_eta/passingRECO/egammaEffi.txt_EGM2D.root");
                  // !! ------------------------------------
                  fL2_ID_SF= new TFile("../../Scale_factors/Ele_SF/Data2023/passingCutBasedTight122XV1/egammaEffi.txt_EGM2D.root");
                  // !! ------------------------------------
                  fL1L2_TRG_SF= new TFile("../../Scale_factors/Ele_SF/Data2023/Trig_2023/trigSF_2D.root");    
                  fL1L2_TRG_SFerr = new TFile("../../Scale_factors/Ele_SF/Data2023/Trig_2023/trigSF_2Derr.root");
               }
         ...
         if(Year == 2022)
            {
               if (isPostAPV){
                  ...
                  fL1_ID_SF= new TFile("../../Scale_factors/DisplacedTop2022_EE/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL1_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2022_EE/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

                  // !!--------------------------------------
                  fL2_Reco_SF_low= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/lowpT/Run3_2022EFG_PostEEMC/passingRECO/egammaEffi.txt_EGM2D.root");
                  fL2_Reco_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/midpT/Run3_2022EFG_New_midpT5/passingRECO/egammaEffi.txt_EGM2D.root ");
                  fL2_Reco_SF2= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/highpT/Run3_2022EFG_New_highpt5/passingRECO/egammaEffi.txt_EGM2D.root");
                  // !! ------------------------------------
                  fL2_ID_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/ForRe-recoE+PromptFG/tnpEleID/passingCutBasedTight122XV1/egammaEffi.txt_EGM2D.root");
                  // !! ------------------------------------
                  fL1L2_TRG_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/Trig_2022/trigSF_2D.root");    
                  fL1L2_TRG_SFerr = new TFile("../../Scale_factors/Ele_SF/Data2022/Trig_2022/trigSF_2Derr.root");

               }
               else{

                  fL1_ID_SF= new TFile("../../Scale_factors/DisplacedTop2022/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL1_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2022/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");
                  // !!--------------------------------------
                  fL2_Reco_SF_low= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/lowpT/Run3_2022BCD_PreEEMC/passingRECO/egammaEffi.txt_EGM2D.root");
                  fL2_Reco_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/midpT/Run3_2022BCD_New_midpT7/passingRECO/egammaEffi.txt_EGM2D.root ");
                  fL2_Reco_SF2= new TFile("../../Scale_factors/Ele_SF/Data2022/New_SF_19122023/highpT/Run3_2022BCD_New_highpt6/passingRECO/egammaEffi.txt_EGM2D.root");
                  // !! ------------------------------------
                  fL2_ID_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/ForRe-recoBCD/tnpEleID/passingCutBasedTight122XV1/egammaEffi.txt_EGM2D.root");
                  // !! ------------------------------------
                  fL1L2_TRG_SF= new TFile("../../Scale_factors/Ele_SF/Data2022/Trig_2022/trigSF_2D.root");    
                  fL1L2_TRG_SFerr = new TFile("../../Scale_factors/Ele_SF/Data2022/Trig_2022/trigSF_2Derr.root");
               }
         ...
         // !!  -- 
         fh2DL2_Reco_SF1 = (TH2F*)(fL2_Reco_SF_low->Get("EGamma_SF2D"));
         fh2DL2_ISO_SF1 = (TH2F*)(fL2_Reco_SF->Get("EGamma_SF2D"));
         fh2DL3_ISO_SF1 = (TH2F*)(fL2_Reco_SF2->Get("EGamma_SF2D"));
         // !!  --
         ...
         fh2DL2_Reco_SF1err = (TH2F*)(fL2_Reco_SF_low->Get("statMC"));
         fh2DL2_ISO_SF1err  = (TH2F*)(fL2_Reco_SF->Get("statMC"));
         fh2DL3_ISO_SF1err  = (TH2F*)(fL2_Reco_SF2->Get("statMC"));
         ...
         if (c1) {
            ...
            if (pad) {
               ...
               std::cout << "TPad  trigger introuvable dans le canvas." << std::endl;
            }
         } else {
   ...
   else if (MuMu > 0 && isMC) // SingleMuon or DiMuon
      {
         if (Year == 2024)
            {
               fL1_ID_SF= new TFile("../../Scale_factors/DisplacedTop2023_Bpix/NUM_TightID_DEN_TrackerMuons/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
               fL1_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2023_Bpix/NUM_MiniIsoTight_DEN_TightID/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

               fL2_ID_SF= new TFile("../../Scale_factors/DisplacedTop2023_Bpix/NUM_TightID_DEN_TrackerMuons/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
               fL2_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2023_Bpix/NUM_MiniIsoTight_DEN_TightID/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

               fL1L2_TRG_SF = new TFile("../../Scale_factors/DisplacedTop2023_Bpix/NUM_Trigger_DEN_MiniIsoTight/NUM_Trigger_DEN_MiniIsoTight_abseta_pt.root");
               fL1L2_TRG_SFerr = new TFile("../../Scale_factors/DisplacedTop2023_Bpix/NUM_Trigger_DEN_MiniIsoTight/NUM_Trigger_DEN_MiniIsoTight_abseta_pt.root");
         ...
         if(Year == 2023)
            {
               if (isPostAPV){
                  ...
                  fL1_ID_SF= new TFile("../../Scale_factors/DisplacedTop2023/NUM_TightID_DEN_TrackerMuons/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL1_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2023/NUM_MiniIsoTight_DEN_TightID/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

                  fL2_ID_SF= new TFile("../../Scale_factors/DisplacedTop2023/NUM_TightID_DEN_TrackerMuons/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL2_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2023/NUM_MiniIsoTight_DEN_TightID/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

                  fL1L2_TRG_SF = new TFile("../../Scale_factors/DisplacedTop2023/NUM_Trigger_DEN_MiniIsoTight/NUM_Trigger_DEN_MiniIsoTight_abseta_pt.root");
                  fL1L2_TRG_SFerr = new TFile("../../Scale_factors/DisplacedTop2023/NUM_Trigger_DEN_MiniIsoTight/NUM_Trigger_DEN_MiniIsoTight_abseta_pt.root");
         ...
         if(Year == 2022)
            {
               if (isPostAPV){
                  fL1_ID_SF= new TFile("../../Scale_factors/DisplacedTop2022_EE/NUM_TightID_DEN_TrackerMuons/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL1_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2022_EE/NUM_MiniIsoTight_DEN_TightID/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

                  fL2_ID_SF= new TFile("../../Scale_factors/DisplacedTop2022_EE/NUM_TightID_DEN_TrackerMuons/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL2_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2022_EE/NUM_MiniIsoTight_DEN_TightID/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

                  fL1L2_TRG_SF = new TFile("../../Scale_factors/DisplacedTop2022_EE/NUM_Trigger_DEN_MiniIsoTight/NUM_Trigger_DEN_MiniIsoTight_abseta_pt.root");
                  fL1L2_TRG_SFerr = new TFile("../../Scale_factors/DisplacedTop2022_EE/NUM_Trigger_DEN_MiniIsoTight/NUM_Trigger_DEN_MiniIsoTight_abseta_pt.root");
               }
               else{
                  ...
                  fL2_ID_SF= new TFile("../../Scale_factors/DisplacedTop2022/NUM_TightID_DEN_TrackerMuons/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL2_ISO_SF= new TFile("../../Scale_factors/DisplacedTop2022/NUM_MiniIsoTight_DEN_TightID/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");

                  fL1L2_TRG_SF = new TFile("../../Scale_factors/DisplacedTop2022/NUM_Trigger_DEN_MiniIsoTight/NUM_Trigger_DEN_MiniIsoTight_abseta_pt.root");
                  fL1L2_TRG_SFerr = new TFile("../../Scale_factors/DisplacedTop2022/NUM_Trigger_DEN_MiniIsoTight/NUM_Trigger_DEN_MiniIsoTight_abseta_pt.root");
               }
   ...
   if (!Signal && isMC)
      {
         ...
         TFile* f1_DY= new TFile("/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_14_0_20/src/FlyingTop/FlyingTop/test/"+Prod+"/"+sample+".root");
         f1_DY->cd("");
...
// !! End Normalisation 
   TString Yearcor = "2024";
   TString YearDaniel = "2024";

   if (Year == 2022 && !isPostAPV) 
   {
      Yearcor = "2022A";
      YearDaniel = "2022";
   }
   ...
   TString MNEU = "";
   TString CT = "";
TString PathDaniel = "/opt/sbg/cms/ui2_data1/blochd/LLTopAna/VertexWeight/"+YearDaniel+"/";
   if ( Signal )// 
      {
         TString hNorma = "h_";
         

         TString SmuonPattern = "Msmu-";
         TString NeuPattern = "Mchi-";
         TString CtauPattern = "ct-";

         Ssiz_t Smuonpos = sample.Index(SmuonPattern);
         Ssiz_t Neupos = sample.Index(NeuPattern);
         Ssiz_t Ctaupos = sample.Index(CtauPattern);

         if (Smuonpos != kNPOS) {
            // Prendre les 3 ou 4 caractères qui suivent
            MSMU = sample(Smuonpos + SmuonPattern.Length(), 3); // ici 4 caractères
            std::cout << "Après '" << SmuonPattern << "' : " << MSMU << std::endl;
         } else {
            std::cout << "Pattern smuon non trouvé !" << std::endl;
         }

         if (Neupos != kNPOS) {
            // Prendre les 3 ou 4 caractères qui suivent
            MNEU = sample(Neupos + NeuPattern.Length(), 3); // ici 4 caractères
            std::cout << "Après '" << NeuPattern << "' : " << MNEU << std::endl;
         } else {
            std::cout << "Pattern  neu non trouvé !" << std::endl;
         }

         if (Ctaupos != kNPOS) {
            // Prendre les 3 ou 4 caractères qui suivent
            int extractlength = 3; // Nombre de caractères à extraire après le motif
            if (thesample.Contains("ct-1000")) {
               extractlength = 4; // Si le motif est "ctau1000", on extrait 4 caractères
            } 
            CT = sample(Ctaupos + CtauPattern.Length(), extractlength); // ici 4 caractères
            std::cout << "Après '" << CtauPattern << "' : " << CT << std::endl;
         } else {
            std::cout << "Pattern ctau  non trouvé !" << std::endl;
         }
      }

         TFile* f1_Vtx_Weight = new TFile(PathDaniel+"h_RPV_"+YearDaniel+"_Msmu-"+MSMU+"_Mchi-"+MNEU+"_ct-"+CT+".root");
         f1_Vtx_Weight->cd("");

         TH1F*  Weight_DOWN_00  = (TH1F*)gROOT->FindObject("hTrkWeight_DOWN_00");
         TH1F*  Weight_UP_00  = (TH1F*)gROOT->FindObject("hTrkWeight_UP_00");
         TH1F*  Weight_DOWN_10  = (TH1F*)gROOT->FindObject("hTrkWeight_DOWN_10");
         TH1F*  Weight_UP_10  = (TH1F*)gROOT->FindObject("hTrkWeight_UP_10");
         TH1F*  Weight_DOWN_20  = (TH1F*)gROOT->FindObject("hTrkWeight_DOWN_20");
         TH1F*  Weight_UP_20  = (TH1F*)gROOT->FindObject("hTrkWeight_UP_20");
         TH1F*  Weight_DOWN_30  = (TH1F*)gROOT->FindObject("hTrkWeight_DOWN_30");
         TH1F*  Weight_UP_30  = (TH1F*)gROOT->FindObject("hTrkWeight_UP_30");
         f1_Vtx_Weight->Close();
      
   // !! Ennd of Vtx Weight Syst


// !! §§ !! ;; 
      // !! Correction for correlation
      float SF_Correlation = 1.;
      TH1F* hSF_Correlation = nullptr;
      TFile*   f_Cor_Correlation = new TFile("/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_14_0_20/src/FlyingTop/FlyingTop/test/ABCDReader/Signal/VtxQuality_Hemipt_2Vtx_EMU_MC_"+Yearcor+".root");
      // if (!isMC)
      //    {
      //       f_Cor_Correlation = new TFile("/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/ABCDReader/Signal/VtxQuality_Hemipt_2Vtx_EMU_DATA_2018.root");
      //    }
      
      
      if (f_Cor_Correlation) {
            // Récupérer le premier TPad (ou cherche un spécifique si tu connais son nom)
            f_Cor_Correlation->cd();
            TPad *pad = (TPad*) f_Cor_Correlation->Get("rap1");
            if (pad) {
               // Récupérer le TH2F à l'intérieur du TPad
               hSF_Correlation = (TH1F*)pad->GetListOfPrimitives()->FindObject("h_ratio");
               //  pad->ls();
               if (hSF_Correlation) {
                     std::cout << "TH1F trouvé: " << hSF_Correlation->GetName() << std::endl;
                     // h2->Draw("COLZ");  // Exemple d'utilisation
               } else {
                     std::cout << "Aucun TH2F trouvé dans le TPad." << std::endl;
               }
            } else {
               std::cout << "TPad correlation introuvable dans le canvas." << std::endl;
            }
         } else {
            std::cout << "Canvas introuvable." << std::endl;
         }
      f_Cor_Correlation->Close();
      // !! §§ !! ;; 
  ...
  // Normalisation factor (XS)
   ...
   float kfactor_dy= 1;//6282.6/6731.99
   if (thesample.Contains("TTto2L2Nu"))                              { XS = 98.0;  FracEffEvent = 0.992;    }// !!  ok
   if (thesample.Contains("WWto2L2Nu"))                              { XS = 13.0;  FracEffEvent = 0.999;    }// !!  ok
   if (thesample.Contains("WZto2L2Q"))                     { XS = 8.2;  FracEffEvent = 0.999;   }// !!  ok
   if (thesample.Contains("ZZto2L2Q"))                     { XS = 8.1;  FracEffEvent = 0.992;   }// !!  ok
   if (thesample.Contains("TbarWplusto2L2Nu"))                     { XS = 4.7;  FracEffEvent = 1.;   }// !!  ok
   if (thesample.Contains("TWminusto2L2Nu"))                     { XS = 4.7;  FracEffEvent = 1.;   }// !!  ok
   if (thesample.Contains("TTLL_MLL-4to50"))                     { XS = 0.04;  FracEffEvent = 0.555;   }// !!  ok
   if (thesample.Contains("TTLL_MLL-50"))                     { XS = 0.09;  FracEffEvent = 0.52;   }// !!  ok
   if (thesample.Contains("TTLNu-1Jets"))                     { XS = 0.25;  FracEffEvent = 0.52;   }// !!  ok
   if (thesample.Contains("TTtoLNu2Q"))                     { XS = 405.6;  FracEffEvent = 99.1;   }// !!  ok : SemiLeptonic   //Signal
   if (thesample.Contains("DYto2Mu_MLL-10to50_TuneCP5_13p6TeV_powheg-pythia8")){XS = 6744.0; FracEffEvent = 0.918;}
   if (thesample.Contains("DYto2Mu_MLL-50to120_TuneCP5_13p6TeV_powheg-pythia8")){XS = 2219*kfactor_dy ; FracEffEvent = 0.98;}
   if (thesample.Contains("DYto2Mu_MLL-120to200_TuneCP5_13p6TeV_powheg-pythia8")){XS = 21.65*kfactor_dy; FracEffEvent = 0.99;}
   if (thesample.Contains("DYto2Mu_MLL-200to400_TuneCP5_13p6TeV_powheg-pythia8")){XS = 3.058*kfactor_dy ; FracEffEvent = 0.996;}
   if (thesample.Contains("DYto2Mu_MLL-400to800_TuneCP5_13p6TeV_powheg-pythia8")){XS = 0.2691*kfactor_dy ; FracEffEvent =0.999 ;}
   if (thesample.Contains("DYto2Tau_MLL-10to50_TuneCP5_13p6TeV_powheg-pythia8")){XS = 6744.0; FracEffEvent =0.917 ;}
   if (thesample.Contains("DYto2Tau_MLL-50to120_TuneCP5_13p6TeV_powheg-pythia8")){XS = 2219*kfactor_dy ; FracEffEvent = 0.98;}
   if (thesample.Contains("DYto2Tau_MLL-120to200_TuneCP5_13p6TeV_powheg-pythia8")){XS = 21.65*kfactor_dy; FracEffEvent = 0.99;}
   if (thesample.Contains("DYto2Tau_MLL-200to400_TuneCP5_13p6TeV_powheg-pythia8")){XS = 3.058*kfactor_dy; FracEffEvent = 0.996;}
   if (thesample.Contains("DYto2Tau_Bin-MLL-400to800_TuneCP5_13p6TeV_powheg-pythia8")){XS = 0.2691*kfactor_dy; FracEffEvent = 0.999;}

   if (thesample.Contains("DYto2L-2Jets_MLL-10to50"))                     { XS = 19982.5; FracEffEvent = 1;   }//// !!   FracEffEvent = 0.747;  okok : 15910 :https://doi.org/10.48550/arXiv.2402.08486
   if (thesample.Contains("DYto2L-2Jets_MLL-50"))                         { XS = 6346.0;  FracEffEvent = 1;     }// !!  FracEffEvent = 0.6658;   ok//5379.0;  ok  }https://doi.org/10.48550/arXiv.2402.08486
   if (thesample.Contains("DYto2Mu_Bin-MLL-10to50_TuneCP5_13p6TeV_powheg-pythia8")){XS = 6744.0; FracEffEvent = 0.918;}
   if (thesample.Contains("DYto2Mu_Bin-MLL-50to120_TuneCP5_13p6TeV_powheg-pythia8")){XS = 2219*kfactor_dy ; FracEffEvent = 0.98;}
   if (thesample.Contains("DYto2Mu_Bin-MLL-120to200_TuneCP5_13p6TeV_powheg-pythia8")){XS = 21.65*kfactor_dy; FracEffEvent = 0.99;}
   if (thesample.Contains("DYto2Mu_Bin-MLL-200to400_TuneCP5_13p6TeV_powheg-pythia8")){XS = 3.058*kfactor_dy ; FracEffEvent = 0.996;}
   if (thesample.Contains("DYto2Mu_Bin-MLL-400to800_TuneCP5_13p6TeV_powheg-pythia8")){XS = 0.2691*kfactor_dy ; FracEffEvent =0.999 ;}

   
   if (thesample.Contains("DYto2Tau_Bin-MLL-10to50_TuneCP5_13p6TeV_powheg-pythia8")){XS = 6744.0; FracEffEvent =0.917 ;}
   if (thesample.Contains("DYto2Tau_Bin-MLL-50to120_TuneCP5_13p6TeV_powheg-pythia8")){XS = 2219*kfactor_dy ; FracEffEvent = 0.98;}
   if (thesample.Contains("DYto2Tau_Bin-MLL-120to200_TuneCP5_13p6TeV_powheg-pythia8")){XS = 21.65*kfactor_dy; FracEffEvent = 0.99;}
   if (thesample.Contains("DYto2Tau_Bin-MLL-200to400_TuneCP5_13p6TeV_powheg-pythia8")){XS = 3.058*kfactor_dy; FracEffEvent = 0.996;}
   if (thesample.Contains("DYto2Tau_Bin-MLL-400to800_TuneCP5_13p6TeV_powheg-pythia8")){XS = 0.2691*kfactor_dy; FracEffEvent = 0.999;}

   
   if (thesample.Contains("DYto2L-4Jets_MLL-10to50_TuneCP5_13p6TeV_madgraphMLM-pythia8")){XS =  19982 ; FracEffEvent =1 ;}//tau naalysis use 6282
   if (thesample.Contains("DYto2L-4Jets_MLL-50_TuneCP5_13p6TeV_madgraphMLM-pythia8")){XS =  6282.6 ; FracEffEvent =1 ;}//tau naalysis use 6282
   if (thesample.Contains("DYto2Mu-4Jets_Bin-MLL-50_TuneCP5_13p6TeV_madgraphMLM-pythia8")){XS =  6346.0 ; FracEffEvent =1 ;}//tau naalysis use 6282
...
fillHisto("StepEffi","",samplename, 4,1 );
                     ...
                     for(unsigned int iel = 0; iel <minitree_lepton_leadingpt2->size(); iel ++)//test    after trigger and lepton selection cut                                    
                        {
                          ...
                          if (minitree_lepton_leadingpt2->at(0) == 0  )
                           ...
                           if ( ele1_pt < 20)
                              ...
                              {
                                 Ele_Reco_SF1 = fh2DL3_ISO_SF1->GetBinContent(fh2DL3_ISO_SF1->GetXaxis()->FindBin(fabs(minitree_lepton_leadingeta2->at(iel))),fh2DL3_ISO_SF1->GetYaxis()->FindBin(minitree_lepton_leadingpt2->at(iel)));
                                 Ele_Reco_SF1err = fh2DL3_ISO_SF1err->GetBinContent(fh2DL3_ISO_SF1err->GetXaxis()->FindBin(fabs(minitree_lepton_leadingeta2->at(iel))),fh2DL3_ISO_SF1err->GetYaxis()->FindBin(minitree_lepton_leadingpt2->at(iel)));
      ...
      Mu_SF =  Mu_ID_SF1 * Mu_ISO_SF1;
      Mu_SF2 =  Mu_ID_SF2 * Mu_ISO_SF2;
      if (Signal)
         {
      ...
      if (!isMC)
         {
            ...
            NormFactor_mu =  (NormFactorSYST*GenWeight*Prefweight*PUweight*top_pt_wt*Mu_SF*TriggerSyst) / FracEffEvent;

            if (MuMu == 0)
               {
                  NormFactor =  (NormFactorSYST*GenWeight*Prefweight*PUweight*top_pt_wt*Mu_SF*Ele_SF*TriggerSyst) / FracEffEvent;
                  NormFactor_ele=  (NormFactorSYST*GenWeight*Prefweight*PUweight*top_pt_wt*Ele_SF*TriggerSyst) / FracEffEvent;
               }
            else
               {
                  NormFactor =  (NormFactorSYST*GenWeight*Prefweight*PUweight*top_pt_wt*Mu_SF*Mu_SF2*TriggerSyst) / FracEffEvent;
                  NormFactor_mu2 =  (NormFactorSYST*GenWeight*Prefweight*PUweight*top_pt_wt*Mu_SF2*TriggerSyst) / FracEffEvent;
               }
   ...
   if (Signal)
      {
            ...
            NormFactor =  NormFactorSYST*Prefweight*PUweight*top_pt_wt*Mu_SF*Mu_SF2*TriggerSyst;
            NormFactor_mu =  NormFactorSYST*Prefweight*PUweight*top_pt_wt*Mu_SF*TriggerSyst;
            NormFactor_mu2 =  NormFactorSYST*Prefweight*PUweight*top_pt_wt*Mu_SF2*TriggerSyst;
            NormFactor_ele=  NormFactorSYST*Prefweight*PUweight*top_pt_wt*Ele_SF*TriggerSyst;
      }
...
float highHpt = 100.;
      ...
      float WeightVtx1_Up = 1;
      float WeightVtx1_Down = 1;
      float WeightVtx2_Up = 1;
      float WeightVtx2_Down = 1;
      float WeightVtx_Up = 1;
      float WeightVtx_Down = 1;
      ...
      float SF_Correlation_Hemi1 = 1;
      float SF_Correlation_Hemi2 = 1;
      if (CorrectCorrelation)
         {
            SF_Correlation_Hemi1 = hSF_Correlation->GetBinContent(hSF_Correlation->GetXaxis()->FindBin(hemi1_pt));
            SF_Correlation_Hemi2 = hSF_Correlation->GetBinContent(hSF_Correlation->GetXaxis()->FindBin(hemi2_pt));
         }

      // float SF_Correlation_Hemi1_err = hSF_Correlation->GetBinError(SF_Correlation_Hemi1);
      // float SF_Correlation_Hemi2_err = hSF_Correlation->GetBinError(SF_Correlation_Hemi2);

      float SF_Correlation_HemiMax = SF_Correlation_Hemi1;
      float SF_Correlation_HemiMin = SF_Correlation_Hemi2;
      ...
      if ( hemi2_pt > hemi1_pt ) {hemi_ptmin = hemi1_pt;hemi_ptmax = hemi2_pt;SF_Correlation_HemiMax = SF_Correlation_Hemi2;SF_Correlation_HemiMin = SF_Correlation_Hemi1;}
      if (!CorrectCorrelation)
         {
            SF_Correlation_Hemi1 = 1;
            SF_Correlation_Hemi2 = 1;
            SF_Correlation_HemiMax = 1;
            SF_Correlation_HemiMin = 1;
         }

      // std::cout<<"SF_Correlation_Hemi1 : "<<SF_Correlation_Hemi1<<std::endl;
      // std::cout<<"SF_Correlation_Hemi2 : "<<SF_Correlation_Hemi2<<std::endl;
...
if ( Vtx_x1 > Vtx_x )     Vtx_x           = Vtx_x1;
         ...
         if (systlist.Contains("VtxUp") && Signal)
            {
                  int ibin0 = Vtx_nTrks0;
                  if ( ibin0 > 51 ) ibin0 = 51;
                  if ( Vtx_dist0 < 10. ) {
                  WeightVtx1_Up     = Weight_UP_00->GetBinContent( ibin0);
                  }
                  else if ( Vtx_dist0 < 20. ) {
                  WeightVtx1_Up     = Weight_UP_10->GetBinContent( ibin0 );
                  }
                  else if ( Vtx_dist0 < 30. ) {;
                  WeightVtx1_Up     = Weight_UP_20->GetBinContent( ibin0 );
                  }
                  else {
                  WeightVtx1_Up     = Weight_UP_30->GetBinContent( ibin0 );
                  }

                  int ibin1 = Vtx_nTrks1;
                  if ( ibin1 > 51 ) ibin1 = 51;
                  if ( Vtx_dist1 < 10. ) {
                  WeightVtx2_Up     = Weight_UP_00->GetBinContent( ibin1);
                  }
                  else if ( Vtx_dist1 < 20. ) {
                  WeightVtx2_Up     = Weight_UP_10->GetBinContent( ibin1 );
                  }
                  else if ( Vtx_dist1 < 30. ) {;
                  WeightVtx2_Up     = Weight_UP_20->GetBinContent( ibin1 );
                  }
                  else {
                  WeightVtx2_Up     = Weight_UP_30->GetBinContent( ibin1 );
                  }


                  int ibin2 = Vtx_nTrks;
                  if ( ibin2 > 51 ) ibin2 = 51;
                  if ( Vtx_dist < 10. ) {
                  WeightVtx_Up     = Weight_UP_00->GetBinContent( ibin2);
                  }
                  else if ( Vtx_dist < 20. ) {
                  WeightVtx_Up     = Weight_UP_10->GetBinContent( ibin2 );
                  }
                  else if ( Vtx_dist < 30. ) {;
                  WeightVtx_Up     = Weight_UP_20->GetBinContent( ibin2 );
                  }
                  else {
                  WeightVtx_Up     = Weight_UP_30->GetBinContent( ibin2 );
                  }
            }
         else if (systlist.Contains("VtxDown") && Signal)
            {
                  int ibin0 = Vtx_nTrks0;
                  if ( ibin0 > 51 ) ibin0 = 51;
                  if ( Vtx_dist0 < 10. ) {
                  WeightVtx1_Down     = Weight_DOWN_00->GetBinContent( ibin0);
                  }
                  else if ( Vtx_dist0 < 20. ) {
                  WeightVtx1_Down     = Weight_DOWN_10->GetBinContent( ibin0 );
                  }
                  else if ( Vtx_dist0 < 30. ) {;
                  WeightVtx1_Down     = Weight_DOWN_20->GetBinContent( ibin0 );
                  }
                  else {
                  WeightVtx1_Down     = Weight_DOWN_30->GetBinContent( ibin0 );
                  }

                  int ibin1 = Vtx_nTrks1;
                  if ( ibin1 > 51 ) ibin1 = 51;
                  if ( Vtx_dist1 < 10. ) {
                  WeightVtx2_Down     = Weight_DOWN_00->GetBinContent( ibin1);
                  }
                  else if ( Vtx_dist1 < 20. ) {
                  WeightVtx2_Down     = Weight_DOWN_10->GetBinContent( ibin1 );
                  }
                  else if ( Vtx_dist1 < 30. ) {;
                  WeightVtx2_Down     = Weight_DOWN_20->GetBinContent( ibin1 );
                  }
                  else {
                  WeightVtx2_Down     = Weight_DOWN_30->GetBinContent( ibin1 );
                  }

                  int ibin2 = Vtx_nTrks;
                  if ( ibin2 > 51 ) ibin2 = 51;
                  if ( Vtx_dist < 10. ) {
                  WeightVtx_Down     = Weight_DOWN_00->GetBinContent( ibin2);
                  }
                  else if ( Vtx_dist < 20. ) {
                  WeightVtx_Down     = Weight_DOWN_10->GetBinContent( ibin2 );
                  }
                  else if ( Vtx_dist < 30. ) {;
                  WeightVtx_Down     = Weight_DOWN_20->GetBinContent( ibin2 );
                  }
                  else {
                  WeightVtx_Down     = Weight_DOWN_30->GetBinContent( ibin2 );
                  }
            }

      float SF_Vtx12_Weight = WeightVtx1_Up * WeightVtx2_Up * WeightVtx1_Down * WeightVtx2_Down;
      float SF_Vtx_Weight = WeightVtx_Up * WeightVtx_Down ;
...
if (isHemiVtx1) nRecoTightVertex1 = 1 ;
   if (isHemiVtx2) nRecoTightVertex2 = 1;
   if (isHemiVtx1Loose) nRecoLooseVertex1 = 1 ;
   if (isHemiVtx2Loose) nRecoLooseVertex2 = 1;
...
fillHisto("hData_VtxQualityTight_Hemileadingpt","2Vtx",samplename,hemi_ptmax,nRecoTightVertex);
      fillHisto("hData_VtxQualityLoose_Hemileadingpt","2Vtx",samplename,hemi_ptmax,nRecoLooseVertex);

      fillHisto("hData_VtxQualityTight_Hemisubleadingpt","2Vtx",samplename,hemi_ptmin,nRecoTightVertex);
      fillHisto("hData_VtxQualityLoose_Hemisubleadingpt","2Vtx",samplename,hemi_ptmin,nRecoLooseVertex);

fillHisto("hData_VtxQualityTight_Hemipt","Focus_2Vtx",samplename,hemi_ptmax,nRecoTightVertex);
      fillHisto("hData_VtxQualityTight_Hemipt","Focus_2Vtx",samplename,hemi_ptmin,nRecoTightVertex);

      fillHisto("hData_VtxQualityTight_Hemileadingpt","Focus_2Vtx",samplename,hemi_ptmax,nRecoTightVertex);
      fillHisto("hData_VtxQualityLoose_Hemileadingpt","Focus_2Vtx",samplename,hemi_ptmax,nRecoLooseVertex);

      fillHisto("hData_VtxQualityTight_Hemisubleadingpt","Focus_2Vtx",samplename,hemi_ptmin,nRecoTightVertex);
      fillHisto("hData_VtxQualityLoose_Hemisubleadingpt","Focus_2Vtx",samplename,hemi_ptmin,nRecoLooseVertex);


      fillHisto("VtxQuality","Vtx1_Tight",samplename,hemi1_pt,nRecoTightVertex1);
      fillHisto("VtxQuality","Vtx1_Loose",samplename,hemi1_pt,nRecoLooseVertex1);

      fillHisto("VtxQuality","Vtx2_Tight",samplename,hemi2_pt,nRecoTightVertex2);
      fillHisto("VtxQuality","Vtx2_Loose",samplename,hemi2_pt,nRecoLooseVertex2);
...
// !! $$ ££ ¤¤ NEW
      if (nVtx == 2)
         {
            fillHisto("hData_2Vtx_VTXMVA","Tight",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_2Vtx_VTXMVA_EVT","Tight",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
         }
      else if (nVtx + nVtxLoose == 2)
         {
            fillHisto("hData_2Vtx_VTXMVA","TightLoose",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_2Vtx_VTXMVA_EVT","TightLoose",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
         }
      else if (nVtxLoose == 2)
         {
            fillHisto("hData_2Vtx_VTXMVA","LooseLoose",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_2Vtx_VTXMVA_EVT","LooseLoose",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );   
         }
// !! $$ ££ ¤¤ NEW 2 

   if (Vtx_step0 >= 1 && Vtx_step0 <= 2 && Vtx_step1 >= 1 && Vtx_step1 <= 2 )
      {
          fillHisto("hData_2Vtx_VtxVTx_VTXMVA","TightTight",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_2Vtx_VtxVTx_VTXMVA_EVT","TightTight",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );  
      }
   else if (Vtx_step0 >= 1 && Vtx_step0 <= 2 && Vtx_step1 >= 3 && Vtx_step1 <= 4 )
      {
            fillHisto("hData_2Vtx_VtxVTx_VTXMVA","TightLoose",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_2Vtx_VtxVTx_VTXMVA_EVT","TightLoose",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );  
      }
   else if (Vtx_step0 >= 3 && Vtx_step0 <= 4 && Vtx_step1 >= 1 && Vtx_step1 <= 2 )
      {
            fillHisto("hData_2Vtx_VtxVTx_VTXMVA","LooseTight",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_2Vtx_VtxVTx_VTXMVA_EVT","LooseTight",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );  
      }
   else if (Vtx_step0 >= 3 && Vtx_step0 <= 4 && Vtx_step1 >= 3 && Vtx_step1 <= 4 )
      {
            fillHisto("hData_2Vtx_VtxVTx_VTXMVA","LooseLoose",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_2Vtx_VtxVTx_VTXMVA_EVT","LooseLoose",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );  
      }
// !! $$ ££ ¤¤ 
      //-----------------------------------------------------------//
   ...
   isCutEvt = false;
    if (!BlindSR) {
      ...
      if (nVtx == 1 && nVtxLoose == 1 && isCutEvt) { // same as Loose since TL = LT
         fillHisto("hData_Hemi_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
         fillHisto("hData_Hemi_TLVtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight);
      }
         
         if (nVtx == 2 && isCutEvt ) {
            fillHisto("hData_Hemi_2Vtx_Mmumu","",samplename,minitree_Mmumu->at(0),NormFactor*SF_Vtx12_Weight);
            fillHisto("hData_Hemi_2Vtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight);
            fillHisto("hData_Hemi_2Vtx_BDTevt","",samplename, minitree_Evts_MVAval->at(0),NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_Hemi_2Vtx_MaxBDTvtx","",samplename, BDTvtx,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_Hemi_2Vtx_SumtrackWeight","",samplename, Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight );
            fillHisto2D("hData_Hemi_2Vtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
         }
      ...
      if (nVtx == 1 && nVtxLoose == 1 && isCutEvt ) { // same as Loose since TL = LT
         fillHisto("hData_Hemi_TLVtx_SumtrackWeight","",samplename,0,NormFactor*SF_Vtx12_Weight);
         fillHisto("hData_Hemi_TLVtx_Mass","",samplename,0,NormFactor*SF_Vtx12_Weight);

      }
         
         if (nVtx == 2 && isCutEvt ) {
            fillHisto("hData_Hemi_2Vtx_Mmumu","",samplename,minitree_Mmumu->at(0),NormFactor*SF_Vtx12_Weight);
            fillHisto("hData_Hemi_2Vtx_Mass","",samplename,0,NormFactor*SF_Vtx12_Weight);
            fillHisto("hData_Hemi_2Vtx_BDTevt","",samplename, 0,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_Hemi_2Vtx_MaxBDTvtx","",samplename, 0,NormFactor*SF_Vtx12_Weight );
            fillHisto("hData_Hemi_2Vtx_SumtrackWeight","",samplename, 0,NormFactor*SF_Vtx12_Weight );
            fillHisto2D("hData_Hemi_2Vtx_STW_Ntrks","",samplename,0,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
      ...
      if (Filter &&  ( (hemi1_pt >= lowHpt && hemi1_pt <highHpt && hemi2_pt >=highHpt) ||
             (hemi2_pt >= lowHpt && hemi2_pt <highHpt && hemi1_pt >=highHpt) ))//hemi_ptmin > lowHpt && hemi_ptmin <highHpt
         {
            ...
            if (nVtx == 1 && nVtxLoose == 1  ) { // same as Loose low pt since TL = LT
                 fillHisto("hData_CRlowpt_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                 fillHisto("hData_CRlowpt_TLVtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight);
                 fillHisto2D("hData_CRlowpt_TLVtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
                             }

            if (nVtx == 2 )
               {
                  fillHisto("hData_CRlowpt_2Vtx_Mmumu","",samplename,  minitree_Mmumu->at(0) ,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlowpt_2Vtx_Mass","",samplename,   VtxMass ,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlowpt_2Vtx_BDTevt","",samplename, minitree_Evts_MVAval->at(0),NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlowpt_2Vtx_MaxBDTvtx","",samplename, BDTvtx ,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlowpt_2Vtx_SumtrackWeight","",samplename, Vtx_SumtrackWeight ,NormFactor*SF_Vtx12_Weight);
                  fillHisto2D("hData_CRlowpt_2Vtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
      ...
      if (Filter &&   hemi1_pt >= lowHpt && hemi1_pt <highHpt && lowHpt < hemi2_pt <highHpt )//hemi_ptmin > lowHpt && hemi_ptmin <highHpt
         {
            ...
            if (nVtx == 1 && nVtxLoose == 1  ) { // same as LooseLowLowpt since TL = LT
                  fillHisto("hData_CRlowlowpt_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlowlowpt_TLVtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight);
                  fillHisto2D("hData_CRlowlowpt_TLVtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
            }

            if (nVtx == 2 )
               {
                  fillHisto("hData_CRlowlowpt_2Vtx_Mmumu","",samplename,  minitree_Mmumu->at(0),NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlowlowpt_2Vtx_Mass","",samplename,   VtxMass ,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlowlowpt_2Vtx_BDTevt","",samplename, minitree_Evts_MVAval->at(0),NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlowlowpt_2Vtx_MaxBDTvtx","",samplename, BDTvtx ,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlowlowpt_2Vtx_SumtrackWeight","",samplename, Vtx_SumtrackWeight ,NormFactor*SF_Vtx12_Weight);
      ...
      if ( Filter ) 
         {
            ...
            if (nVtx == 1 && nVtxLoose == 1 && isCutEvt ) { 
                  fillHisto("hData_CRloose_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRloose_TLVtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight);
                  fillHisto2D("hData_CRloose_TLVtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
                              }

            if (nVtxLoose == 2 && isCutEvt)
               {
                  fillHisto("hData_CRloose_2Vtx_Mmumu","",samplename,  minitree_Mmumu->at(0) ,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRloose_2Vtx_Mass","",samplename,   VtxMass,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRloose_2Vtx_BDTevt","",samplename, minitree_Evts_MVAval->at(0),NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRloose_2Vtx_MaxBDTvtx","",samplename, BDTvtx,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRloose_2Vtx_SumtrackWeight","",samplename, Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight );
                  fillHisto2D("hData_CRloose_2Vtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
                                 }  
         }
      ...
      if (Filter && ( (hemi1_pt >= lowHpt && hemi1_pt <highHpt && hemi2_pt >=highHpt) ||
             (hemi2_pt >= lowHpt && hemi2_pt <highHpt && hemi1_pt >=highHpt) )  )//hemi_ptmin > lowHpt && hemi_ptmin <highHpt
         {
                  ...
                  fillHisto("hData_CRlooselowpt_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlooselowpt_TLVtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight);

                                    fillHisto2D("hData_CRlooselowpt_TLVtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
                  

            }
            if (nVtxLoose == 2)
               {
                  fillHisto("hData_CRlooselowpt_2Vtx_Mmumu","",samplename,  minitree_Mmumu->at(0),NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselowpt_2Vtx_Mass","",samplename,   VtxMass,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRlooselowpt_2Vtx_SumtrackWeight","",samplename, Vtx_SumtrackWeight ,NormFactor*SF_Vtx12_Weight);

                  fillHisto2D("hData_CRlooselowpt_2Vtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
      ...
      if (Filter &&  hemi1_pt >= lowHpt && hemi1_pt <highHpt &&  lowHpt <= hemi2_pt  &&  hemi2_pt <=highHpt   )//hemi_ptmin > lowHpt && hemi_ptmin <highHpt
         {
            ...
            if (nVtx == 1 && nVtxLoose == 1  ) {
                  fillHisto("hData_CRlooselowlowpt_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlooselowlowpt_TLVtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight);

                  fillHisto2D("hData_CRlooselowlowpt_TLVtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
                              }
            if (nVtxLoose == 2)
               {
                  fillHisto("hData_CRlooselowlowpt_2Vtx_Mmumu","",samplename,  minitree_Mmumu->at(0),NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselowlowpt_2Vtx_Mass","",samplename,   VtxMass,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRlooselowlowpt_2Vtx_SumtrackWeight","",samplename, Vtx_SumtrackWeight ,NormFactor*SF_Vtx12_Weight);

                  fillHisto2D("hData_CRlooselowlowpt_2Vtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
         ...
         // !! New closure tests in the low pt region of the hemispheres
      if (Filter &&  hemi1_pt >= lowHpt && hemi1_pt <60 &&  lowHpt <= hemi2_pt  &&  hemi2_pt <=60)
         {
            if ( nVtx == 0 && nVtxLoose == 2 ) 
               {
                  fillHisto("hData_CRlooselooselowlowpt_TLVtx_SumtrackWeight","Closure",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","Ave_Closure",samplename,AveBDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowlowpt_Closure",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
               }
         }
      ...
      if (Filter &&  hemi1_pt >= lowHpt && hemi1_pt <60 &&  lowHpt <= hemi2_pt  &&  hemi2_pt <=60 )
         {
            if ( (nVtx == 1 && nVtxLoose == 1) || (nVtx == 2 && nVtxLoose == 0) ) 
               {
                  fillHisto("hData_CRtightlowlowpt_TLVtx_SumtrackWeight","Closure",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","Ave_Closure",samplename,AveBDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("2Vtx_VtxVtx_EVT_MVA","tightlowlowpt_Closure",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
               }
         }
      
      if (Filter &&  ((hemi1_pt >= 60 && hemi2_pt >= 60 && hemi1_pt <= 100 && hemi2_pt <= 100) 
         || ( (hemi1_pt >= lowHpt && hemi1_pt <60 && hemi2_pt >= 60 && hemi2_pt <= 100) 
         || ( hemi2_pt >= lowHpt && hemi2_pt < 60 && hemi1_pt >= 60 && hemi1_pt <= 100) )  )
         )//hemi_ptmin > lowHpt && hemi_ptmin < 80.
         {
            if ( nVtx == 0 && nVtxLoose == 2 ) 
               {
                  fillHisto("hData_CRlooselooselowpt_TLVtx_SumtrackWeight","Closure",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","Ave_Closure",samplename,AveBDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowpt_Closure",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
               }
         }
      if (Filter &&  ((hemi1_pt >= 60 && hemi2_pt >= 60 && hemi1_pt <= 100 && hemi2_pt <= 100) 
         || ( (hemi1_pt >= lowHpt && hemi1_pt <60 && hemi2_pt >= 60 && hemi2_pt <= 100) 
         ...
         )
         {
            if ( (nVtx == 1 && nVtxLoose == 1) || (nVtx == 2 && nVtxLoose == 0)  ) 
               {
                  fillHisto("hData_CRtighthighpt_TLVtx_SumtrackWeight","Closure",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRtighthighpt_2Vtx_NEWMVA","Ave_Closure",samplename,AveBDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("2Vtx_VtxVtx_EVT_MVA","tighthighpt_Closure",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
               }
         }
      ...
      if (Filter &&  hemi1_pt >= lowHpt && hemi1_pt <highHpt &&  lowHpt <= hemi2_pt  &&  hemi2_pt <=highHpt   )//hemi_ptmin > lowHpt && hemi_ptmin <highHpt
         {
            fillHisto("hData_CRlooselooselowlowpt_BDTevt","",samplename, minitree_Evts_MVAval->at(0),NormFactor*SF_Vtx12_Weight );
            if ( nVtx == 0 && nVtxLoose == 2 ) {
                  // fillHisto("hData_CRlooselooselowlowpt_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRlooselooselowlowpt_TLVtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight);


                  fillHisto2D("hData_CRlooselooselowlowpt_TLVtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
                  
                  // !! $$ ----------------------
                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
fillHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowlowpt",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
fillHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowlowpt_Focus",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
fillHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowlowpt_DiffBin",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight  );

fillHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","diffBin",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","6Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","7Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","8Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","Sum",samplename,SumBDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","Ave",samplename,AveBDTVal,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_STW","Sum",samplename,SumSTW,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_STW","Ave",samplename,AveSTW,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_STW","SumdiffBin",samplename,SumSTW,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowlowpt_2Vtx_STW","AvediffBin",samplename,AveSTW,NormFactor*SF_Vtx12_Weight );
...
// !! --------------------
               ...
               // !! Control Plots
                  ...
                  fillHisto("Step","BestVtx_A",samplename,Vtx_step,NormFactor*SF_Vtx12_Weight );
                  fillHisto("r","BestVtx_A",samplename,Vtx_r,NormFactor*SF_Vtx12_Weight );
                  fillHisto("z","BestVtx_A",samplename,abs(Vtx_z),NormFactor*SF_Vtx12_Weight );
                  fillHisto("STW","BestVtx_A",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight );
                  fillHisto("Mass","BestVtx_A",samplename,VtxMass,NormFactor*SF_Vtx12_Weight );
                  fillHisto("ntrk10","BestVtx_A",samplename,Vtx_ntrk10,NormFactor*SF_Vtx12_Weight );
               fillHisto("MeanDCA","BestVtx_A",samplename,Vtx_track_MeanDCA_d,NormFactor*SF_Vtx12_Weight );
               // !! -------------

                  fillHisto("hData_CRlooselooselowlowpt_dist_VtxVtx","",samplename,  Vtx_Vtx_dist,NormFactor*SF_Vtx12_Weight );
                  ...
                  fillHisto("hData_CRlooselooselowlowpt_TLVtx_SumtrackWeight","8Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                                    if (Vtx_SumtrackWeight0 > 7 ) { Vtx_SumtrackWeight0 = 7.5;}
                  if (Vtx_SumtrackWeight1 > 7 ) { Vtx_SumtrackWeight1 = 7.5;}
                  fillHisto("hData_CRlooselooselowlowpt_TLVtx_SumtrackWeight","7Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  if (Vtx_SumtrackWeight0 > 6 ) { Vtx_SumtrackWeight0 = 6.5;}
                  if (Vtx_SumtrackWeight1 > 6 ) { Vtx_SumtrackWeight1 = 6.5;}
                  fillHisto("hData_CRlooselooselowlowpt_TLVtx_SumtrackWeight","6Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                     fillHisto("hData_CRlooselooselowlowpt_TLVtx_SumtrackWeight","diffBin",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
            }
         }
      ...
      if (Filter &&  hemi1_pt >= lowHpt && hemi1_pt <highHpt &&  lowHpt <= hemi2_pt  &&  hemi2_pt <=highHpt )//hemi_ptmin > lowHpt && hemi_ptmin <highHpt
         {
            ...
            if ( (nVtx == 1 && nVtxLoose == 1 ) || (nVtx == 2 && nVtxLoose == 0) ){
                  ...
                  fillHisto("hData_CRtightlowlowpt_TLVtx_Mass","",samplename,VtxMass,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2);
                  fillHisto2D("hData_CRtightlowlowpt_TLVtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2);

                  // !! $$ ----------------------
                  fillHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );

                  fillHisto("2Vtx_VtxVtx_EVT_MVA","tightlowlowpt",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
fillHisto("2Vtx_VtxVtx_EVT_MVA","tightlowlowpt_Focus",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );

                  fillHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","diffBin",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","6Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","7Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","8Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );

                  fillHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","Sum",samplename,SumBDTVal,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","Ave",samplename,AveBDTVal,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );

                  fillHisto("hData_CRtightlowlowpt_2Vtx_STW","Sum",samplename,SumSTW,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("hData_CRtightlowlowpt_2Vtx_STW","Ave",samplename,AveSTW,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );

                  fillHisto("hData_CRtightlowlowpt_2Vtx_STW","SumdiffBin",samplename,SumSTW,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("hData_CRtightlowlowpt_2Vtx_STW","AvediffBin",samplename,AveSTW,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );

                                                    
                  fillHisto("2Vtx_VtxVtx_EVT_MVA","tightlowlowpt_DiffBin",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  // !! $$ ----------------------
                  // !! Control Plots
                  ...
                  fillHisto("Step","BestVtx_B",samplename,Vtx_step,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("r","BestVtx_B",samplename,Vtx_r,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("z","BestVtx_B",samplename,abs(Vtx_z),NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("STW","BestVtx_B",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("Mass","BestVtx_B",samplename,VtxMass,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("ntrk10","BestVtx_B",samplename,Vtx_ntrk10,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );
                  fillHisto("MeanDCA","BestVtx_B",samplename,Vtx_track_MeanDCA_d,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );

                  fillHisto("SF_Cor","", samplename,  SF_Correlation_Hemi1,1);
                  fillHisto("SF_Cor","", samplename, SF_Correlation_Hemi2,1);
         // !! ------------

                  fillHisto("hData_CRtightlowlowpt_dist_VtxVtx","",samplename,  Vtx_Vtx_dist,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2 );


                  fillHisto("hData_CRtightlowlowpt_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2);
                  

                  if (Vtx_SumtrackWeight0 > 8 ) { Vtx_SumtrackWeight0 = 8.5;}
                  if (Vtx_SumtrackWeight1 > 8 ) { Vtx_SumtrackWeight1 = 8.5;}
                  fillHisto("hData_CRtightlowlowpt_TLVtx_SumtrackWeight","8Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2);


                  if (Vtx_SumtrackWeight0 > 7 ) { Vtx_SumtrackWeight0 = 7.5;}
                  if (Vtx_SumtrackWeight1 > 7 ) { Vtx_SumtrackWeight1 = 7.5;}
                  fillHisto("hData_CRtightlowlowpt_TLVtx_SumtrackWeight","7Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2);


                  if (Vtx_SumtrackWeight0 > 6 ) { Vtx_SumtrackWeight0 = 6.5;}
                  if (Vtx_SumtrackWeight1 > 6 ) { Vtx_SumtrackWeight1 = 6.5;}
                  fillHisto("hData_CRtightlowlowpt_TLVtx_SumtrackWeight","6Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2);
fillHisto("hData_CRtightlowlowpt_TLVtx_SumtrackWeight","diffBin",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight*SF_Correlation_Hemi1*SF_Correlation_Hemi2);
            }
         }
      ...
      if (Filter &&  ((hemi1_pt >= highHpt && hemi2_pt >= highHpt) || ( (hemi1_pt >= lowHpt && hemi1_pt <highHpt && hemi2_pt >=highHpt) ||
             (hemi2_pt >= lowHpt && hemi2_pt <highHpt && hemi1_pt >=highHpt) )  ))//hemi_ptmin > lowHpt && hemi_ptmin < 80.
         {
            ...
            if (nVtxLoose == 2 && nVtx == 0)
               {
                  fillHisto("hData_CRlooselooselowpt_2Vtx_Mmumu","",samplename,  minitree_Mmumu->at(0),NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowpt_2Vtx_Mass","",samplename,   VtxMass,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRlooselooselowpt_2Vtx_SumtrackWeight","",samplename, Vtx_SumtrackWeight ,NormFactor*SF_Vtx12_Weight);

                  fillHisto2D("hData_CRlooselooselowpt_2Vtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
                  

                  // !! $$ ----------------------
                  fillHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );

                  fillHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowpt",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
fillHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowpt_Focus",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );

fillHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","diffBin",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","6Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","7Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","8Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","Sum",samplename,SumBDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","Ave",samplename,AveBDTVal,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRlooselooselowpt_2Vtx_STW","Sum",samplename,SumSTW,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowpt_2Vtx_STW","Ave",samplename,AveSTW,NormFactor*SF_Vtx12_Weight );
fillHisto("hData_CRlooselooselowpt_2Vtx_STW","SumdiffBin",samplename,SumSTW,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRlooselooselowpt_2Vtx_STW","AvediffBin",samplename,AveSTW,NormFactor*SF_Vtx12_Weight );

                  fillHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowpt_DiffBin",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight   );
                  // !! $$ ----------------------
...
// !! --------------------
               // !! Control Plots
                  ...
                  fillHisto("Step","BestVtx_D",samplename,Vtx_step,NormFactor*SF_Vtx12_Weight );
                  fillHisto("r","BestVtx_D",samplename,Vtx_r,NormFactor*SF_Vtx12_Weight );
                  fillHisto("z","BestVtx_D",samplename,abs(Vtx_z),NormFactor*SF_Vtx12_Weight );
                  fillHisto("STW","BestVtx_D",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight );
                  fillHisto("Mass","BestVtx_D",samplename,VtxMass,NormFactor*SF_Vtx12_Weight );
                  fillHisto("ntrk10","BestVtx_D",samplename,Vtx_ntrk10,NormFactor*SF_Vtx12_Weight );
               fillHisto("MeanDCA","BestVtx_D",samplename,Vtx_track_MeanDCA_d,NormFactor*SF_Vtx12_Weight );
               // !! -------------



                  fillHisto("hData_CRlooselooselowpt_dist_VtxVtx","",samplename,  Vtx_Vtx_dist,NormFactor*SF_Vtx12_Weight );


                  fillHisto("hData_CRlooselooselowpt_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
...
fillHisto("hData_CRlooselooselowpt_TLVtx_SumtrackWeight","8Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);


                                    if (Vtx_SumtrackWeight0 > 7 ) { Vtx_SumtrackWeight0 = 7.5;}
                  if (Vtx_SumtrackWeight1 > 7 ) { Vtx_SumtrackWeight1 = 7.5;}
                  
fillHisto("hData_CRlooselooselowpt_TLVtx_SumtrackWeight","7Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);


                  if (Vtx_SumtrackWeight0 > 6 ) { Vtx_SumtrackWeight0 = 6.5;}
                  if (Vtx_SumtrackWeight1 > 6 ) { Vtx_SumtrackWeight1 = 6.5;}
                  
fillHisto("hData_CRlooselooselowpt_TLVtx_SumtrackWeight","6Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
fillHisto("hData_CRlooselooselowpt_TLVtx_SumtrackWeight","diffBin",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
               }
...
if ((nVtx == 1 && nVtxLoose == 1) || (nVtx == 2 && nVtxLoose == 0))
   {
      ...
      if (Filter &&  ((hemi1_pt >= highHpt && hemi2_pt >= highHpt) || ( (hemi1_pt >= lowHpt && hemi1_pt <highHpt && hemi2_pt >=highHpt) ||
             (hemi2_pt >= lowHpt && hemi2_pt <highHpt && hemi1_pt >=highHpt) )  ))//hemi_ptmin > lowHpt && hemi_ptmin < 80.
         {
            fillHisto("hData_CRtighthighpt_BDTevt","",samplename, minitree_Evts_MVAval->at(0),NormFactor*SF_Vtx12_Weight );

            if (nVtx == 2 || (nVtx == 1 && nVtxLoose == 1 ) ){
   
                  fillHisto("hData_CRtighthighpt_2Vtx_Mmumu","",samplename,  minitree_Mmumu->at(0),NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRtighthighpt_2Vtx_Mass","",samplename,   VtxMass,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRtighthighpt_2Vtx_SumtrackWeight","",samplename, Vtx_SumtrackWeight ,NormFactor*SF_Vtx12_Weight);

                  fillHisto2D("hData_CRtighthighpt_2Vtx_STW_Ntrks","",samplename,Vtx_SumtrackWeight,Vtx_nTrks,NormFactor*SF_Vtx12_Weight);
                  
                  
                  // !! $$ ----------------------
                  fillHisto("hData_CRtighthighpt_2Vtx_NEWMVA","",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("2Vtx_VtxVtx_EVT_MVA","tighthighpt",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
fillHisto("2Vtx_VtxVtx_EVT_MVA","tighthighpt_Focus",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );

                  fillHisto("2Vtx_VtxVtx_EVT_MVA","tighthighpt_DiffBin",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
                  
                                    fillHisto("hData_CRtighthighpt_2Vtx_NEWMVA","diffBin",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRtighthighpt_2Vtx_NEWMVA","6Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRtighthighpt_2Vtx_NEWMVA","7Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRtighthighpt_2Vtx_NEWMVA","8Bins",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRtighthighpt_2Vtx_NEWMVA","Sum",samplename,SumBDTVal,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRtighthighpt_2Vtx_NEWMVA","Ave",samplename,AveBDTVal,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRtighthighpt_2Vtx_STW","Sum",samplename,SumSTW,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRtighthighpt_2Vtx_STW","Ave",samplename,AveSTW,NormFactor*SF_Vtx12_Weight );

                  fillHisto("hData_CRtighthighpt_2Vtx_STW","SumdiffBin",samplename,SumSTW,NormFactor*SF_Vtx12_Weight );
                  fillHisto("hData_CRtighthighpt_2Vtx_STW","AvediffBin",samplename,AveSTW,NormFactor*SF_Vtx12_Weight );
                  // !! $$ ----------------------
            ...
            fillHisto("Step","BestVtx_C",samplename,Vtx_step,NormFactor*SF_Vtx12_Weight );
            fillHisto("r","BestVtx_C",samplename,Vtx_r,NormFactor*SF_Vtx12_Weight );
            fillHisto("z","BestVtx_C",samplename,abs(Vtx_z),NormFactor*SF_Vtx12_Weight );
            fillHisto("STW","BestVtx_C",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight );
            fillHisto("Mass","BestVtx_C",samplename,VtxMass,NormFactor*SF_Vtx12_Weight );
            fillHisto("ntrk10","BestVtx_C",samplename,Vtx_ntrk10,NormFactor*SF_Vtx12_Weight );
            fillHisto("MeanDCA","BestVtx_C",samplename,Vtx_track_MeanDCA_d,NormFactor*SF_Vtx12_Weight );
            // !! Control Plots
            


                  fillHisto("hData_CRtighthighpt_TLVtx_SumtrackWeight","",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  ...
                  if (Vtx_SumtrackWeight0 > 8 ) { Vtx_SumtrackWeight0 = 8.5;}
                  if (Vtx_SumtrackWeight1 > 8 ) { Vtx_SumtrackWeight1 = 8.5;}
                  fillHisto("hData_CRtighthighpt_TLVtx_SumtrackWeight","8Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);


                                    if (Vtx_SumtrackWeight0 > 7 ) { Vtx_SumtrackWeight0 = 7.5;}
                  if (Vtx_SumtrackWeight1 > 7 ) { Vtx_SumtrackWeight1 = 7.5;}

                  fillHisto("hData_CRtighthighpt_TLVtx_SumtrackWeight","7Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);

                  
                                    if (Vtx_SumtrackWeight0 > 6 ) { Vtx_SumtrackWeight0 = 6.5;}
                  if (Vtx_SumtrackWeight1 > 6 ) { Vtx_SumtrackWeight1 = 6.5;}

                  fillHisto("hData_CRtighthighpt_TLVtx_SumtrackWeight","6Bins",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
                  fillHisto("hData_CRtighthighpt_TLVtx_SumtrackWeight","diffBin",samplename,Vtx_SumtrackWeight,NormFactor*SF_Vtx12_Weight);
         ...
         fillHisto("NewBDT_GlobalOutput","BestScore",samplename,Best_BDTVal,NormFactor*SF_Vtx12_Weight );
         fillHisto("NewBDT_GlobalOutput","BothScore",samplename,Vtx1_bdtVal,NormFactor*SF_Vtx12_Weight );
         fillHisto("NewBDT_GlobalOutput","BothScore",samplename,Vtx2_bdtVal,NormFactor*SF_Vtx12_Weight );

         fillHisto("NewEVTBDT_GlobalOutput","Score",samplename,VTX_BDTVal_EVT,NormFactor*SF_Vtx12_Weight );
...
float binEdgesSTW[nbin5+1] = {1,2,3,4,6,7};
...
addHisto("SF_Cor","", sample.Data(), 20,0,2);

addHisto("hData_CRlooselooselowlowpt_TLVtx_SumtrackWeight","Closure",sample.Data(),19,1,20);
addHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","Ave_Closure",sample.Data(),  20,-1,1  );
addHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowlowpt_Closure",sample.Data(),20,-1,1  );

addHisto("hData_CRtightlowlowpt_TLVtx_SumtrackWeight","Closure",sample.Data(),19,1,20);
addHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","Ave_Closure",sample.Data(),20,-1,1  );
addHisto("2Vtx_VtxVtx_EVT_MVA","tightlowlowpt_Closure",sample.Data(),20,-1,1 );

addHisto("hData_CRlooselooselowpt_TLVtx_SumtrackWeight","Closure",sample.Data(),19,1,20);
addHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","Ave_Closure",sample.Data(),20,-1,1 );
addHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowpt_Closure",sample.Data(),20,-1,1 );

addHisto("hData_CRtighthighpt_TLVtx_SumtrackWeight","Closure",sample.Data(),19,1,20);
addHisto("hData_CRtighthighpt_2Vtx_NEWMVA","Ave_Closure",sample.Data(),20,-1,1  );
addHisto("2Vtx_VtxVtx_EVT_MVA","tighthighpt_Closure",sample.Data(),20,-1,1 );
...
addHisto("hData_2Vtx_VTXMVA","Tight",sample.Data(),20,-1,1 );
addHisto("hData_2Vtx_VTXMVA_EVT","Tight",sample.Data(),20,-1,1);

addHisto("hData_2Vtx_VTXMVA","TightLoose",sample.Data(),20,-1,1 );
   addHisto("hData_2Vtx_VTXMVA_EVT","TightLoose",sample.Data(),20,-1,1);

addHisto("hData_2Vtx_VTXMVA","LooseLoose",sample.Data(),20,-1,1 );
addHisto("hData_2Vtx_VTXMVA_EVT","LooseLoose",sample.Data(),20,-1,1);   

   addHisto("hData_2Vtx_VtxVTx_VTXMVA","TightTight",sample.Data(),20,-1,1 );
addHisto("hData_2Vtx_VtxVTx_VTXMVA_EVT","TightTight",sample.Data(),20,-1,1);  

addHisto("hData_2Vtx_VtxVTx_VTXMVA","TightLoose",sample.Data(),20,-1,1 );
addHisto("hData_2Vtx_VtxVTx_VTXMVA_EVT","TightLoose",sample.Data(),20,-1,1);  

addHisto("hData_2Vtx_VtxVTx_VTXMVA","LooseTight",sample.Data(),20,-1,1 );
addHisto("hData_2Vtx_VtxVTx_VTXMVA_EVT","LooseTight",sample.Data(),20,-1,1);  

   addHisto("hData_2Vtx_VtxVTx_VTXMVA","LooseLoose",sample.Data(),20,-1,1);
addHisto("hData_2Vtx_VtxVTx_VTXMVA_EVT","LooseLoose",sample.Data(),20,-1,1);  


addHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowlowpt",sample.Data(),10,-1,1);
addHisto("2Vtx_VtxVtx_EVT_MVA","tightlowlowpt",sample.Data(),10,-1,1);
addHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowpt",sample.Data(),10,-1,1 );
   addHisto("2Vtx_VtxVtx_EVT_MVA","tighthighpt",sample.Data(),10,-1,1);

addHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowlowpt_Focus",sample.Data(),10,0.7,0.8);
addHisto("2Vtx_VtxVtx_EVT_MVA","tightlowlowpt_Focus",sample.Data(),10,0.7,0.8);
addHisto("2Vtx_VtxVtx_EVT_MVA","looselooselowpt_Focus",sample.Data(),10,0.7,0.8 );
   addHisto("2Vtx_VtxVtx_EVT_MVA","tighthighpt_Focus",sample.Data(),10,0.7,0.8);


float binEdgesEvtBDT[11] = {-1,-0.8,-0.6,-0.4,-0.2,0.,0.2,0.4,0.6,0.75,1};
addHistoDiffBin("2Vtx_VtxVtx_EVT_MVA","looselooselowlowpt_DiffBin",sample.Data(),10,binEdgesEvtBDT );
addHistoDiffBin("2Vtx_VtxVtx_EVT_MVA","tightlowlowpt_DiffBin",sample.Data(),10,binEdgesEvtBDT );
addHistoDiffBin("2Vtx_VtxVtx_EVT_MVA","looselooselowpt_DiffBin",sample.Data(),10,binEdgesEvtBDT  );
addHistoDiffBin("2Vtx_VtxVtx_EVT_MVA","tighthighpt_DiffBin",sample.Data(),10,binEdgesEvtBDT );

   addHisto("VtxQuality","Vtx1_Tight",sample.Data(), 50,0,1000);
   addHisto("VtxQuality","Vtx1_Loose",sample.Data(), 50,0,1000);

   addHisto("VtxQuality","Vtx2_Tight",sample.Data(), 50,0,1000);
   addHisto("VtxQuality","Vtx2_Loose",sample.Data(), 50,0,1000);
...
// !! ££
   ...
   // !! $$    -----------------
addHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","",sample.Data(),10,-1,1);
...
addHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","",sample.Data(),10,-1,1 );
...
addHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","",sample.Data(),10,-1,1 );
...
addHisto("hData_CRtighthighpt_2Vtx_NEWMVA","",sample.Data(),10,-1,1);
...
addHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","Sum",sample.Data(),10,-2,2);
addHisto("hData_CRlooselooselowlowpt_2Vtx_NEWMVA","Ave",sample.Data(),10,-1,1);

addHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","Sum",sample.Data(),10,-2,2);
addHisto("hData_CRtightlowlowpt_2Vtx_NEWMVA","Ave",sample.Data(),10,-1,1 );

addHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","Sum",sample.Data(),10,-2,2 );
addHisto("hData_CRlooselooselowpt_2Vtx_NEWMVA","Ave",sample.Data(),10,-1,1 );

addHisto("hData_CRtighthighpt_2Vtx_NEWMVA","Sum",sample.Data(),10,-2,2 );
addHisto("hData_CRtighthighpt_2Vtx_NEWMVA","Ave",sample.Data(),10,-1,1);
...
//-----------AddHisto ------//
   ...
   addHisto("hData_VtxQualityTight_Hemileadingpt","2Vtx",sample.Data(), 50,0,1000);
   addHisto("hData_VtxQualityLoose_Hemileadingpt","2Vtx",sample.Data(), 50,0,1000);

   addHisto("hData_VtxQualityTight_Hemisubleadingpt","2Vtx",sample.Data(), 50,0,1000);
   addHisto("hData_VtxQualityLoose_Hemisubleadingpt","2Vtx",sample.Data(), 50,0,1000);

   addHisto("hData_VtxQualityTight_Hemipt","Focus_2Vtx",sample.Data(), 2,30,50);
   addHisto("hData_VtxQualityLoose_Hemipt","Focus_2Vtx",sample.Data(), 2,30,50);

   addHisto("hData_VtxQualityTight_Hemileadingpt","Focus_2Vtx",sample.Data(), 2,30,50);
      addHisto("hData_VtxQualityLoose_Hemileadingpt","Focus_2Vtx",sample.Data(), 2,30,50);

   addHisto("hData_VtxQualityTight_Hemisubleadingpt","Focus_2Vtx",sample.Data(), 2,30,50);
   addHisto("hData_VtxQualityLoose_Hemisubleadingpt","Focus_2Vtx",sample.Data(),2,30,50);

   
   addHisto("Hemisphere_leadingpt","", sample.Data(), 30,0,300);
   addHisto("Hemisphere_subleadingpt","", sample.Data(), 30,0,300);
