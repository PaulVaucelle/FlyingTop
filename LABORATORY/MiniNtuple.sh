...
for infile in "${input_files[@]}"; do
    ...
    ./MiniNtuple "/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/MC_EMU_2018_03_02_2025/$infile.root" "./EMU/MiniDATAMC_$infile.root"
done
