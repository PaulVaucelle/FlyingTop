...
// //--------------------DATA 2018 MiniSecIntNtuples ------------//
  TString BKGSet[1]={"DoubleMuon_2022"};
...
// "emu_2018B",
 for (int i = 0 ; i< 1 ; i++) 
    {
      // TString Path = "/opt/sbg/cms/ui2_data1/blochd/NTUPLES_FLY/Data_2022_emu/240819/"+BKGSet[i]+".root";
      TString Path = "/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_14_0_8_FLY/src/FlyingTop/FlyingTop/test/DATA_MUMU_2022_25_09_2024/"+BKGSet[i]+".root";
