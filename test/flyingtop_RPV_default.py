...
if Year == 2022 :
    ...
    TRKBDT = "BDT_TRK_241028_2022A_ctau100vsEMUdata.xml"
    if isPost :
        TIGHTJETIDERA = 'RUN3CHSruns2022FGruns2023CD'
        MCPUFILE   = 'PU_Run2022EE_MC.root'
        TRKBDT = "BDT_TRK_241108_2022B_ctau100vsEMUdata.xml"
        ...
        JERSFDATA = 'Summer22EE_22Sep2023_JRV1_DATA_SF_AK4PFPuppi.txt' #Summer2
...
if Year == 2023 :
    ...
    JECUNCDATA = 'Summer23Prompt23_V1_MC_Uncertainty_AK4PFchs.txt'
    JECUNCMC   = 'Summer23Prompt23_V1_MC_Uncertainty_AK4PFPuppi.txt'
    JERMC      = 'Summer23Prompt23_RunCv1234_JRV1_MC_PtResolution_AK4PFPuppi.txt'
    JERSFMC    = 'Summer23Prompt23_RunCv1234_JRV1_MC_SF_AK4PFPuppi.txt'
    JERDATA    = 'Summer23Prompt23_RunCv1234_JRV1_DATA_PtResolution_AK4PFchs.txt'
    JERSFDATA  = 'Summer23Prompt23_RunCv1234_JRV1_DATA_SF_AK4PFPuppi.txt'
    TRKBDT = "BDT_TRK_241122_2023A_ctau100vsEMUdata.xml"
    if isPost :
        ...
        TRKBDT = "BDT_TRK_241119_2023B_ctau100vsEMUdata.xml"
