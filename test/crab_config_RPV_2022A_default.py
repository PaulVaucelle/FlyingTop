...
##############------------------------------Monte-Carlos------------------------###############
config.Data.inputDataset = '/Zto2SmuTo2Mu2ChiTo2Top2Stop_inputSample_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer22MiniAODv4-130X_mcRun3_2022_realistic_v5-v2/MINIAODSIM'
...
#$$
config.Data.outLFNDirBase = '/store/user/pvaucell/RPV_2022cor/A/Run3Summer22MiniAODv4-130X_mcRun3_2022_realistic_v5'
#$$
