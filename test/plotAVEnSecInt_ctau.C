...
void plot(std::vector<TString> Sample , TString YEAR, TString SELECTION,TString PU,TString ctau, TString msmu, TString mneu , TString NAMECTAU  )
{
 TFile *f1;
TString Prod = "SecInt";
TString Year = YEAR;
...
// *****************************************************************************
 ...
 //************************
  ...
  TFile *fX[nMC];
  TString NameMC[7] = {
    "M_{#tilde{#mu}} = 200 GeV, M_{#tilde{#chi}} = 180 GeV",
    "M_{#tilde{#mu}} = 250 GeV, M_{#tilde{#chi}} = 180 GeV",
    "M_{#tilde{#mu}} = 300 GeV, M_{#tilde{#chi}} = 180 GeV",
    "M_{#tilde{#mu}} = 350 GeV, M_{#tilde{#chi}} = 180 GeV",
    "M_{#tilde{#mu}} = 400 GeV, M_{#tilde{#chi}} = 180 GeV",
    "M_{#tilde{#mu}} = 450 GeV, M_{#tilde{#chi}} = 180 GeV",
    "M_{#tilde{#mu}} = 500 GeV, M_{#tilde{#chi}} = 180 GeV"
  }

  // TString NameMC[7] = {
  //   "M_{#tilde{#mu}} = 200 GeV, M_{#tilde{#chi}} = 180 GeV",
  //   "M_{#tilde{#mu}} = 250 GeV, M_{#tilde{#chi}} = 230 GeV",
  //   "M_{#tilde{#mu}} = 300 GeV, M_{#tilde{#chi}} = 280 GeV",
  //   "M_{#tilde{#mu}} = 350 GeV, M_{#tilde{#chi}} = 330 GeV",
  //   "M_{#tilde{#mu}} = 400 GeV, M_{#tilde{#chi}} = 380 GeV",
  //   "M_{#tilde{#mu}} = 450 GeV, M_{#tilde{#chi}} = 430 GeV",
  //   "M_{#tilde{#mu}} = 500 GeV, M_{#tilde{#chi}} = 480 GeV"
  // }

  // TString NameMC[9] = {
  //   "M_{#tilde{#mu}} = 300 GeV, M_{#tilde{#chi}} = 200 GeV",
  //   "M_{#tilde{#mu}} = 350 GeV, M_{#tilde{#chi}} = 250 GeV",
  //   "M_{#tilde{#mu}} = 400 GeV, M_{#tilde{#chi}} = 200 GeV",
  //   "M_{#tilde{#mu}} = 400 GeV, M_{#tilde{#chi}} = 300 GeV",
  //   "M_{#tilde{#mu}} = 450 GeV, M_{#tilde{#chi}} = 250 GeV",
  //   "M_{#tilde{#mu}} = 450 GeV, M_{#tilde{#chi}} = 350 GeV",
  //   "M_{#tilde{#mu}} = 500 GeV, M_{#tilde{#chi}} = 240 GeV",
  //   "M_{#tilde{#mu}} = 500 GeV, M_{#tilde{#chi}} = 200 GeV",
  //   "M_{#tilde{#mu}} = 500 GeV, M_{#tilde{#chi}} = 300 GeV"
...
/////////
  ...
  leg->SetHeader("Signal : c#tau = "+NAMECTAU+" cm ");
...
TString lumiText = lumi_13TeV+lumi_sqrtS;
 ...
 c1->Update();
 c1->SaveAs(ctau+"_mneu180_AVE_"+Suffix+".pdf");
}
