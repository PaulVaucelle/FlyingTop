...
// Mon Mar 25 09:30:33 2024 by ROOT version 6.14/09
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(("/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/BDT090/"+sample+".root").Data());
      if (!f || !f->IsOpen()) {
         f = new TFile(("/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/BDT090/"+sample+".root").Data());
      }
      TDirectory * dir = (TDirectory*)f->Get("/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/BDT090/"+sample+".root:/FlyingTop");
...
void TreeReader::LoadTreeSizes(TreeFormat theFormat){
   ...
   track_size     = tree_track_pt->size();
   muon_size      = tree_muon_pt->size();
   
   
   // PV_size        = tree_PV_NChi2->size();
   //SV_size        = tree_secondaryVtx_X->size();
   // PFJet_size     = tree_jet_pt->size();
}
