...
//  gROOT->ProcessLine(".L TreeABCDReader.C+");
  ...
  // systlist.push_back("");
  systlist.push_back("Lumi2016preVFPUp");
  systlist.push_back("Lumi2016preVFPDown");
  systlist.push_back("L12016preVFPUp");
  systlist.push_back("L12016preVFPDown");
  systlist.push_back("Trigger2016preVFPDown");
  systlist.push_back("Trigger2016preVFPUp");
  systlist.push_back("MuonID2016preVFPUp");
  systlist.push_back("MuonID2016preVFPDown");
  systlist.push_back("MuonISO2016preVFPUp");
  systlist.push_back("MuonISO2016preVFPDown");
  systlist.push_back("PU2016preVFPUp");
  systlist.push_back("PU2016preVFPDown");
  // systlist.push_back("JEC2016preVFPUp");
  // systlist.push_back("JEC2016preVFPDown");
  // systlist.push_back("JER2016preVFPUp");
  // systlist.push_back("JER2016preVFPDown");
  systlist.push_back("Vtx2016preVFPUp");
  systlist.push_back("Vtx2016preVFPDown");
  ...
  int YEAR = 2016;
  TString Year = "2016preVFP";
  TString Prod = "Signal_2016PRE"; //DATAMC2018_EMU_10_06_2024 //  EMU: SYST_EMU_CTAU100/Prod100_EMU_JER_up !! M: SYST_CTAU100/Prod100_JER_up // BKG MC and Data PROD_ANNIVERSAIRE_2024
...
//             else if (systlist[j] == "JEC2016preVFPUp")
//               {
//                 Prod = "Signal_2016PRE_JECUp";
//               }
//             else if (systlist[j] == "JEC2016preVFPDown")
//               {
//                 Prod = "Signal_2016PRE_JECDown";
//               }
//             else if (systlist[j] == "JER2016preVFPUp")
//               {
//                 Prod = "Signal_2016PRE_JERUp";
//               }
//             else if (systlist[j] == "JER2016preVFPDown")
//               {
//                 Prod = "Signal_2016PRE_JERDown";
//               }
//             else
//               {
//                 Prod = "Signal_2016PRE";
