{
 ...
 // Compile user's analysis class //
   ...
   gROOT->ProcessLine(".L MiniGenNtuple.C+g") ;
  
 if (gROOT->GetClass("MiniGenNtuple")==0) return;
 ...
 for (int i = 0 ; i< 34 ; i++) 
    {
      ...
      c.Reset();
      c.Add(Path);
       MiniGenNtuple* t = new MiniGenNtuple(&c);
       t->Loop(SignalSet001[i],Prod,Signal);
       std::cout<<"Reading signal sample : "<<SignalSet001[i]<<std::endl;
    }
...
// //////////////////////////////////////////////////////////////////////////////
// // TString SignalSet[6]={"RPV_"+Year+"_smu300_neu250_ctau001","RPV_"+Year+"_smu300_neu250_ctau003","RPV_"+Year+"_smu300_neu250_ctau010","RPV_"+Year+"_smu300_neu250_ctau030","RPV_"+Year+"_smu300_neu250_ctau300","RPV_"+Year+"_smu300_neu250_ctau1000"};
