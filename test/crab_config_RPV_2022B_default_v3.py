...
##############------------------------------Monte-Carlos------------------------###############
config.Data.inputDataset = '/Zto2SmuTo2Mu2ChiTo2Top2Stop_inputSample_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v3/MINIAODSIM'
...
#$$
config.Data.outLFNDirBase = '/store/user/pvaucell/MC/RPV_2022cor/B_v3/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6'
#$$
