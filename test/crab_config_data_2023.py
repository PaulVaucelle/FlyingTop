...
config.JobType.psetName = 'flyingtop_data_2023.py'
...
##############------------------------------Data------------------------###############
# config.Data.inputDataset = '/MuonEG/Run2023B-22Sep2023-v1/MINIAOD'
...
#$$
config.Data.outLFNDirBase = '/store/user/pvaucell/DATA_MUMU_2023_24_09_2024'
#$$
