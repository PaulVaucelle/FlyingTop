...
TString Prod = "RPV_2023A_JECUp";
bool Signal = true;
TString GlobalPath = "/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_14_0_20/src/FlyingTop/FlyingTop/test/"; 
////////////////////////////////////////////////////////////////////////////////
 
      TString SignalSet001[34]={
         "RPV_2023A_Msmu-200_Mchi-180_ct-001","RPV_2023A_Msmu-250_Mchi-180_ct-001","RPV_2023A_Msmu-250_Mchi-200_ct-001",
 ...
 for (int i = 0; i< 34 ; i++) 
    {
      ...
      TString SignalSet003[34]={
         "RPV_2023A_Msmu-200_Mchi-180_ct-003","RPV_2023A_Msmu-250_Mchi-180_ct-003","RPV_2023A_Msmu-250_Mchi-200_ct-003",
 ...
 for (int i = 0; i< 34 ; i++) 
    {
      ...
      TString SignalSet010[34]={
         "RPV_2023A_Msmu-200_Mchi-180_ct-010","RPV_2023A_Msmu-250_Mchi-180_ct-010","RPV_2023A_Msmu-250_Mchi-200_ct-010",
 ...
 for (int i = 0; i< 34 ; i++) 
    {
      ...
      TString SignalSet030[34]={
         "RPV_2023A_Msmu-200_Mchi-180_ct-030","RPV_2023A_Msmu-250_Mchi-180_ct-030","RPV_2023A_Msmu-250_Mchi-200_ct-030",
...
"RPV_2023A_Msmu-500_Mchi-480_ct-030"
 ...
 for (int i = 0 ; i< 34 ; i++) 
    ...
    TString SignalSet100[34]={
      "RPV_2023A_Msmu-200_Mchi-180_ct-100","RPV_2023A_Msmu-250_Mchi-180_ct-100","RPV_2023A_Msmu-250_Mchi-200_ct-100",
 ...
 for (int i = 0; i< 34 ; i++) 
    {
      ...
      TString SignalSet300[34]={
         "RPV_2023A_Msmu-200_Mchi-180_ct-300","RPV_2023A_Msmu-250_Mchi-180_ct-300","RPV_2023A_Msmu-250_Mchi-200_ct-300",
      ...
      c.Add(Path);
       ...
       t->Loop(SignalSet300[i],Prod,Signal);
          ...
          TString SignalSet1000[34]={
            "RPV_2023A_Msmu-200_Mchi-180_ct-1000","RPV_2023A_Msmu-250_Mchi-180_ct-1000","RPV_2023A_Msmu-250_Mchi-200_ct-1000",
