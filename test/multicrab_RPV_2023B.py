...
list_arguments = [
 ...
 ,"Msmu-400_Mchi-180_ct-003","Msmu-400_Mchi-200_ct-003","Msmu-400_Mchi-250_ct-003","Msmu-400_Mchi-300_ct-003","Msmu-400_Mchi-350_ct-003","Msmu-400_Mchi-380_ct-003"
...
#$$    sedFileZ = "sed -e 's#inputSample#" + list_arguments[i]+"#' flyingtop_temp2.py > flyingtop_temp.py"
    ...
    os.system(sedFileZ) 
    sedFile = "sed -e 's#inputSample#" + list_arguments[i]+"#' crab_config_RPV_2023B_default.py > crab_config_temp.py"
    os.system(sedFile) 
