...
#ifndef MiniGenNtuple_h
#define MiniGenNtuple_h
...
TBranch        *b_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v;   //!
   ...
   MiniGenNtuple(TTree *tree=0);
   virtual ~MiniGenNtuple();
...
#ifdef MiniGenNtuple_cxx
MiniGenNtuple::MiniGenNtuple(TTree *tree) : fChain(0) 
{
...
MiniGenNtuple::~MiniGenNtuple()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MiniGenNtuple::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MiniGenNtuple::LoadTree(Long64_t entry)
{
...
void MiniGenNtuple::Init(TTree *tree)
{
...
void MiniGenNtuple::Show(Long64_t entry)
{
...
Int_t MiniGenNtuple::Cut(Long64_t entry)
{
