...
#$$
config.JobType.inputFiles = ['BDT_TRK_241122_2023A_ctau100vsEMUdata.xml'
			    ...
			    ,'PU_Run2023_MC.root'
                            ...
                            ,'Summer23Prompt23_V1_MC_Uncertainty_AK4PFchs.txt'
                            ,'Summer23Prompt23_V1_MC_Uncertainty_AK4PFPuppi.txt'
                            ,'Summer23Prompt23_RunCv1234_JRV1_MC_PtResolution_AK4PFPuppi.txt'
                            ,'Summer23Prompt23_RunCv1234_JRV1_MC_SF_AK4PFPuppi.txt'
                            ,'Summer23Prompt23_RunCv1234_JRV1_DATA_PtResolution_AK4PFchs.txt'
                            ,'Summer23Prompt23_RunCv1234_JRV1_DATA_SF_AK4PFPuppi.txt'
			    ,'RoccoR2018UL.txt']
#$$
...
##############------------------------------Monte-Carlos------------------------###############
config.Data.inputDataset = '/Zto2SmuTo2Mu2ChiTo2Top2Stop_inputSample_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23MiniAODv4-130X_mcRun3_2023_realistic_v15-v1/MINIAODSIM'
...
#$$
config.Data.outLFNDirBase = '/store/user/pvaucell/RPV_2023/250428/Run3Summer23MiniAODv4-130X_mcRun3_2023_realistic_v15'
#$$
