...
process.p = cms.Path(process.GoodVertexFilter* process.egammaPostRecoSeq* process.pileupJetIdUpdated* process.FlyingTop)

#process.p = cms.Path(process.FlyingTop) 
# getattr(process,'slimmedJets').addTagInfos = cms.bool(True)
########## output of ntuple

process.TFileService = cms.Service("TFileService", fileName = cms.string("Ntuple_data_test.root") )
