...
float binEdgesNewBDT[nbin6+1] = {-1,-0.8,-0.6,0.,0.8,0.99,1};
float binEdgesEvtBDT[11] = {-1,-0.8,-0.6,-0.4,-0.2,0.,0.2,0.4,0.6,0.75,1};
float* BINEDGE = nullptr;

std::vector<float*> BINEDGES;
BINEDGES.push_back(binEdgesBestBDT);
BINEDGES.push_back(binEdgesSTW);
BINEDGES.push_back(binEdgesSumSTW);
BINEDGES.push_back(binEdgesAveSTW);

  if (Method == 0)
  {
    htitleA = "hData_CRtightlowlowpt_2Vtx_NEWMVA_diffBin";//
    htitleB = "hData_CRlooselooselowlowpt_2Vtx_NEWMVA_diffBin";//
    htitleC = "hData_CRtighthighpt_2Vtx_NEWMVA_diffBin";//
    htitleD = "hData_CRlooselooselowpt_2Vtx_NEWMVA_diffBin";//

    nbin = nbin6; 
    BINEDGE = binEdgesBestBDT;
    HeaderA = ">= 1 tight";
    HeaderB = "2 loose";
    HeaderC = ">= 1 tight";
    HeaderD = "2 loose";
...
if (Method == 1)
  {
    htitleA = "hData_CRtightlowlowpt_2Vtx_STW_SumdiffBin";//
    htitleB = "hData_CRlooselooselowlowpt_2Vtx_STW_SumdiffBin";//
    htitleC = "hData_CRtighthighpt_2Vtx_STW_SumdiffBin";//
    htitleD = "hData_CRlooselooselowpt_2Vtx_STW_SumdiffBin";//

    nbin = nbin5; 
    BINEDGE = binEdgesSumSTW;
    ...
    HeaderNVtx = "2 Vertices";
    xtitle = "Sum of Sum of the track weight at Vtx";
  }

if (Method == 2)
  {
    htitleA = "hData_CRtightlowlowpt_2Vtx_STW_AvediffBin";//
    htitleB = "hData_CRlooselooselowlowpt_2Vtx_STW_AvediffBin";//
    htitleC = "hData_CRtighthighpt_2Vtx_STW_AvediffBin";//
    htitleD = "hData_CRlooselooselowpt_2Vtx_STW_AvediffBin";//

    nbin = nbin4; 
    BINEDGE = binEdgesAveSTW ;
...
HeaderBbis = "2 hemi., p_{T}< "+HTcut+" GeV";
    ...
    HeaderNVtx = "2 Vertices";
    xtitle = "Average of Sum of track weights at Vtx";
  }

if (Method == 3)
  {
    htitleA = "hData_CRtightlowlowpt_TLVtx_SumtrackWeight_diffBin";//
    htitleB = "hData_CRlooselooselowlowpt_TLVtx_SumtrackWeight_diffBin";//
    htitleC = "hData_CRtighthighpt_TLVtx_SumtrackWeight_diffBin";//
    htitleD = "hData_CRlooselooselowpt_TLVtx_SumtrackWeight_diffBin";//
...
if (Method == 4)
  {
    htitleA = "2Vtx_VtxVtx_EVT_MVA_tightlowlowpt_DiffBin";//
    htitleB = "2Vtx_VtxVtx_EVT_MVA_looselooselowlowpt_DiffBin";//
    htitleC = "2Vtx_VtxVtx_EVT_MVA_tighthighpt_DiffBin";//
    htitleD = "2Vtx_VtxVtx_EVT_MVA_looselooselowpt_DiffBin";//

    nbin = 10; 
    BINEDGE = binEdgesEvtBDT ;
    HeaderA = ">= 1 tight";
    HeaderB = "2 loose";
    HeaderC = ">= 1 tight";
    HeaderD = "2 loose";
...
//------x);
 ...
 h1_LLP = new TH1F("h1_LLP","",nbin,BINEDGE); 
 ...
 h2_LLP = new TH1F("h2_LLP","",nbin,BINEDGE);
 ...
 h3_LLP = new TH1F("h3_LLP","",nbin,BINEDGE);
 h3_LLP->Add(g3_LLP, h3_LLP, 1,0);
  ...
  f4_LLP->cd();
   ...
   h4_LLP = new TH1F("h4_LLP","",nbin,BINEDGE);
  h4_LLP->Add(g4_LLP, h4_LLP, 1,0);
   ...
   h5_LLP = new TH1F("h5_LLP","",nbin,BINEDGE);
  h5_LLP->Add(g5_LLP, h5_LLP, 1,0);
   ...
   h6_LLP = new TH1F("h6_LLP","",nbin,BINEDGE);
  h6_LLP->Add(g6_LLP, h6_LLP, 1,0);
   ...
   h7_LLP = new TH1F("h7_LLP","",nbin,BINEDGE);
