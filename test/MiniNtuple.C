...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH1D* hData_Good_PV = new TH1D("hData_Good_PV","",2,-0.5,1.5);
   TH1D* hData_Filter = new TH1D("hData_Filter","",2,-0.5,1.5);
   TH1D* hData_FilterSameSign = new TH1D("hData_FilterSameSign","",2,-0.5,1.5);
   TH1D* hData_njetNOmu_Filter = new TH1D("hData_njetNOmu_Filter","",31,-0.5,30.5);
   TH1D* hData_njetNOmu_FilterSameSign = new TH1D("hData_njetNOmu_FilterSameSign","",31,-0.5,30.5);
   TH1D* hData_njetNOmu = new TH1D("hData_njetNOmu","",31,-0.5,30.5);
   ...
   std::vector<bool>  miniHLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v;//2018
   std::vector<bool>  miniHLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v;//2018
