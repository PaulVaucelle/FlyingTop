...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = "DATA_MUMU_2024_04_06_2025"

        config.JobType.pluginName = 'Analysis'
        config.JobType.psetName = 'flyingtop_data_2024_CDE.py'
        ...
        config.Data.outLFNDirBase = '/store/user/pvaucell/DATA_MUMU_2024_04_06_2025'
