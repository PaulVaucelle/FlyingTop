...
//signal
 TFile* f1_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau001_"+syst+".root");
 TFile* f2_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau003_"+syst+".root");
 TFile* f3_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau010_"+syst+".root");
 TFile* f4_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau030_"+syst+".root");
 TFile* f5_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau100_"+syst+".root");
 TFile* f6_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau300_"+syst+".root");
 TFile* f7_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau1000_"+syst+".root");

TString FILE[7] = {"RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau001_"+syst+"_",
                  "RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau003_"+syst+"_",
                  "RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau010_"+syst+"_",
                  "RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau030_"+syst+"_",
                  "RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau100_"+syst+"_",
                  "RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau300_"+syst+"_",
                  "RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau1000_"+syst+"_"};
...
//------x);
 ...
 h1_LLP->GetYaxis()->SetTitle(ytitle + HeaderA);
...
if (logy)
  ...
  {
    h1_LLP->SetMinimum(1); 
    h1_LLP->SetMaximum(h1_LLP->GetMaximum()*2); 
  }
