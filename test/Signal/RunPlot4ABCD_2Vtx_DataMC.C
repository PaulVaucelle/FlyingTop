...
void RunPlot4ABCD_2Vtx_DataMC() {
    ...
    TString Prod = "RPV_"+Year+"";//pour Emu DATAMC2018_EMU_10_06_2024 //Mumu PROD_CSI_10_06_2024 // PROD_ANNIVERSAIRE_2024
    if (Year == "2022A") Prod = "RPV_2022A";
    if (Year == "2022B") Prod = "RPV_2022B";
    if (Year == "2023A") Prod = "RPV_2023A";
    if (Year == "2023B") Prod = "RPV_2023";
    if (Year == "2024") Prod = "RPV_2024";
    TString Dmode = "DM";
    int MSmuon = 200;
    int MNeu = 180;
    TString ctau = "100";
