...
//  gROOT->ProcessLine(".L TreeABCDReader.C+");
  ...
  //   systlist.push_back("");
  // systlist.push_back("Lumi2022BUp");
  // systlist.push_back("Lumi2022BDown");
  // systlist.push_back("L12022BUp");
  // systlist.push_back("L12022BDown");
  // systlist.push_back("Trigger2022BDown");
  // systlist.push_back("Trigger2022BUp");
  // systlist.push_back("MuonID2022BUp");
  // systlist.push_back("MuonID2022BDown");
  // systlist.push_back("MuonISO2022BUp");
  // systlist.push_back("MuonISO2022BDown");
  // systlist.push_back("PU2022BUp");
  // systlist.push_back("PU2022BDown");
  systlist.push_back("JEC2022BUp");
  systlist.push_back("JEC2022BDown");
  systlist.push_back("JER2022BUp");
  systlist.push_back("JER2022BDown");
  // systlist.push_back("Vtx2022BUp");
  // systlist.push_back("Vtx2022BDown");
  ...
  int YEAR = 2022;
  TString Year = "2022B";
  TString Prod = "RPV_2022B"; //DATAMC2018_EMU_10_06_2024 //  EMU: SYST_EMU_CTAU100/Prod100_EMU_JER_up !! M: SYST_CTAU100/Prod100_JER_up // BKG MC and Data PROD_ANNIVERSAIRE_2024
  bool isPostAPV = true;
  bool Signal = true;
  bool SameSign = false;
  bool Forward = false; 
...
//  // Signal
      ...
      TString SignalSet001[34]={        "RPV_2022B_Msmu-200_Mchi-180_ct-001","RPV_2022B_Msmu-250_Mchi-180_ct-001","RPV_2022B_Msmu-250_Mchi-200_ct-001",
...
// //  issue RPV_"+Year+"_smu300_neu200_ctau003- 
// problem with 21-
 for (int i =0; i< 34 ; i++) 
    {
for (unsigned int j = 0 ; j < systlist.size(); j++)
...
delete t;
      ...
      TString SignalSet010[34]={         "RPV_2022B_Msmu-200_Mchi-180_ct-010","RPV_2022B_Msmu-250_Mchi-180_ct-010","RPV_2022B_Msmu-250_Mchi-200_ct-010",
...
for (unsigned int j = 0 ; j < systlist.size(); j++)
      ...
      TString SignalSet030[34]={         "RPV_2022B_Msmu-200_Mchi-180_ct-030","RPV_2022B_Msmu-250_Mchi-180_ct-030","RPV_2022B_Msmu-250_Mchi-200_ct-030",
...
for (unsigned int j = 0 ; j < systlist.size(); j++)
  ...
  TString SignalSet100[34]={      "RPV_2022B_Msmu-200_Mchi-180_ct-100","RPV_2022B_Msmu-250_Mchi-180_ct-100","RPV_2022B_Msmu-250_Mchi-200_ct-100",
...
delete t;
      ...
      TString SignalSet300[34]={         "RPV_2022B_Msmu-200_Mchi-180_ct-300","RPV_2022B_Msmu-250_Mchi-180_ct-300","RPV_2022B_Msmu-250_Mchi-200_ct-300",
...
for (unsigned int j = 0 ; j < systlist.size(); j++)
      ...
      TString SignalSet1000[34]={            "RPV_2022B_Msmu-200_Mchi-180_ct-1000","RPV_2022B_Msmu-250_Mchi-180_ct-1000","RPV_2022B_Msmu-250_Mchi-200_ct-1000",
