...
//  if (Year == "2022A") Yearcor = "2016preVFP";
//  if (Year == "2022BB") Yearcor = "2016";
//   if (Year == "2023A") Yearcor = "2016preVFP";
//  if (Year == "2023B") Yearcor = "2016";
//   if (Year == "2024") Yearcor = "2016preVFP";
...
TString filename1 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-001.root";
TString filename2 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-003.root";
TString filename3 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-010.root";
TString filename4 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-030.root";
TString filename5 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-100.root";
TString filename6 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-300.root";
TString filename7 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-1000.root";

if (Year == "2024") 
  {
    filename1 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-001-MChi-"+MNeu+"-MSmu-"+MSmuon+".root";
    filename2 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-003-MChi-"+MNeu+"-MSmu-"+MSmuon+".root";
    filename3 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-010-MChi-"+MNeu+"-MSmu-"+MSmuon+".root";
    filename4 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-030-MChi-"+MNeu+"-MSmu-"+MSmuon+".root";
    filename5 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-100-MChi-"+MNeu+"-MSmu-"+MSmuon+".root";
    filename6 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-300-MChi-"+MNeu+"-MSmu-"+MSmuon+".root";
    filename7 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-1000-MChi-"+MNeu+"-MSmu-"+MSmuon+".root";
  }

 TFile* f1_LLP = new TFile("../../"+Prod+"/"+filename1);
 TFile* f2_LLP = new TFile("../../"+Prod+"/"+filename2);
 TFile* f3_LLP = new TFile("../../"+Prod+"/"+filename3);
 TFile* f4_LLP = new TFile("../../"+Prod+"/"+filename4);
 TFile* f5_LLP = new TFile("../../"+Prod+"/"+filename5);
 TFile* f6_LLP = new TFile("../../"+Prod+"/"+filename6);
 TFile* f7_LLP = new TFile("../../"+Prod+"/"+filename7);


TString FILE[7] = {
                  "RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-001_",
                  "RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-003_",
                  "RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-010_",
                  "RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-030_",
                  "RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-100_",
                  "RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-300_",
                  "RPV_"+Yearcor+"_Msmu-"+MSmuon+"_Mchi-"+MNeu+"_ct-1000_"
                  };
if (Year == "2024")
  {
    FILE[0] = "RPV_"+Yearcor+"_Par-ct-001-MChi-"+MNeu+"-MSmu-"+MSmuon+"_";
    FILE[1] = "RPV_"+Yearcor+"_Par-ct-003-MChi-"+MNeu+"-MSmu-"+MSmuon+"_";
    FILE[2] = "RPV_"+Yearcor+"_Par-ct-010-MChi-"+MNeu+"-MSmu-"+MSmuon+"_";
    FILE[3] = "RPV_"+Yearcor+"_Par-ct-030-MChi-"+MNeu+"-MSmu-"+MSmuon+"_";
    FILE[4] = "RPV_"+Yearcor+"_Par-ct-100-MChi-"+MNeu+"-MSmu-"+MSmuon+"_";
    FILE[5] = "RPV_"+Yearcor+"_Par-ct-300-MChi-"+MNeu+"-MSmu-"+MSmuon+"_";
    FILE[6] = "RPV_"+Yearcor+"_Par-ct-1000-MChi-"+MNeu+"-MSmu-"+MSmuon+"_";
  }
