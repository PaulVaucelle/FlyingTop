...
TString theoutputfileNAME = "histofile_HT100_"+CHANNEL+"_"+ADD_Text+"_"+samplename+"";
   // if (CorrectCorrelation) {theoutputfileNAME = "histofile_HT100_"+CHANNEL+"_"+ADD_Text+"_"+samplename+"Test_Corr";}
...
// !! §§ !! ;; 
  ...
  // Normalisation factor (XS)
   ...
   if (thesample.Contains("DYto2L-2Jets_MLL-10to50"))                     { XS = 19982.5; FracEffEvent = 1.;   }//// !!  okok : 15910 :https://doi.org/10.48550/arXiv.2402.08486
   if (thesample.Contains("DYto2L-2Jets_MLL-50"))                         { XS = 6346.0;  FracEffEvent = 1.;     }// !!  ok//5379.0;  ok  }https://doi.org/10.48550/arXiv.2402.08486
   if (thesample.Contains("TTTo2L2Nu"))                              { XS = 98.0;  FracEffEvent = 0.993;    }// !!  ok
   if (thesample.Contains("WWTo2L2Nu"))                              { XS = 13.0;  FracEffEvent = 0.997;    }// !!  ok
   if (thesample.Contains("WZTo2Q2L_mllmin4p0"))                     { XS = 8.2;  FracEffEvent = 0.583;   }// !!  ok
   if (thesample.Contains("ZZTo2Q2L_mllmin4p0"))                     { XS = 8.1;  FracEffEvent = 0.612;   }// !!  ok
   if (thesample.Contains("TbarWplusto2L2Nu"))                     { XS = 4.7;  FracEffEvent = 0.612;   }// !!  ok
   if (thesample.Contains("TWminusto2L2Nu"))                     { XS = 4.7;  FracEffEvent = 0.612;   }// !!  ok
   if (thesample.Contains("TTLL_MLL-4to50"))                     { XS = 0.04;  FracEffEvent = 0.612;   }// !!  ok
   if (thesample.Contains("TTLL_MLL-50"))                     { XS = 0.09;  FracEffEvent = 0.612;   }// !!  ok
   if (thesample.Contains("TTLNu-1Jets"))                     { XS = 0.25;  FracEffEvent = 0.612;   }// !!  ok
   if (thesample.Contains("TTtoLNu2Q"))                     { XS = 405.6;  FracEffEvent = 0.612;   }// !!  ok : SemiLeptonic
   //Signal
...
if (thesample.Contains("smu-200") || thesample.Contains("Smu-200"))
    {        
    ...
    if (thesample.Contains("smu-250")|| thesample.Contains("Smu-250"))
    {        
    ...
    if (thesample.Contains("smu-300")||thesample.Contains("Smu-300"))
    {        
    ...
    if (thesample.Contains("smu-350")||thesample.Contains("Smu-350"))
    {        
    ...
    if (thesample.Contains("smu-400")||thesample.Contains("Smu-400"))
    {        
    ...
    if (thesample.Contains("smu-450")||thesample.Contains("Smu-450"))
    {        
    ...
    if (thesample.Contains("smu-500")||thesample.Contains("Smu-500"))
    {        
...
if (isMC)
   ...
   if (!isMC)//<=> Data
     ...
     PUweight = miniPUweight->at(0);
         ...
         if (systlist.Contains("Lumi"+YearCombine+"Up"))
            {
               NormFactorSYST =  NormFactorLumiUp/norm;
            }
         else if (systlist.Contains("Lumi"+YearCombine+"Down"))
            {
               NormFactorSYST =  NormFactorLumiDown/norm;
            }
         else if (systlist.Contains("XS"+YearCombine+"Up"))
            {
               NormFactorSYST =  NormFactorXSUp/norm;
            }
         else if (systlist.Contains("XS"+YearCombine+"Down"))
            {
               NormFactorSYST =  NormFactorXSDown/norm;
            }
         else if (systlist.Contains("L1"+YearCombine+"Up"))
            {
               Prefweight = PrefweightUp;
            }
         else if (systlist.Contains("L1"+YearCombine+"Down"))
            {
               Prefweight = PrefweightDown;
            }
         else if (systlist.Contains("Trigger"+YearCombine+"Down"))
            {
               TriggerSyst = triggerSF-triggerSFerr;
               
            }
         else if (systlist.Contains("Trigger"+YearCombine+"Up"))
            {
               TriggerSyst = triggerSF+triggerSFerr;
            }
         else if (systlist.Contains("MuonID"+YearCombine+"Up"))
            {
               if (MuMu == 0)
                  {
         ...
         else if (systlist.Contains("MuonID"+YearCombine+"Down"))
            {
               if (MuMu == 0)
                  {
                     Mu_SF = Mu_Reco_SF1* (Mu_ID_SF1-Mu_ID_SF1err) * Mu_ISO_SF1;
         ...
         else if (systlist.Contains("MuonISO"+YearCombine+"Up"))
            {
               if (MuMu == 0)
                  {
         ...
         else if (systlist.Contains("MuonISO"+YearCombine+"Down"))
            {
               if (MuMu == 0)
                  {
                     Mu_SF = Mu_Reco_SF1* Mu_ID_SF1 * (Mu_ISO_SF1-Mu_ISO_SF1err);
         ...
         else  if (systlist.Contains("PU"+YearCombine+"Up"))
            {
               PUweight = PUweightUp;
            }
         else if (systlist.Contains("PU"+YearCombine+"Down"))
            {
               PUweight = PUweightDown;
            }
         else if (systlist.Contains("TopPt"+YearCombine+"Up"))
            {
               if(thesample.Contains("TTTo2L2Nu") || thesample.Contains("TTToHadronic") ||  thesample.Contains("TTToSemiLeptonic")){
                  top_pt_wt=minitree_genTop_Weight->at(0);
                  // top_pt_wt=1;
         ...
         else if (systlist.Contains("TopPt"+YearCombine+"Down"))
            {
               top_pt_wt=1;
            }
...
if ( Vtx1_ntrk10 > Vtx_ntrk10 ) Vtx_ntrk10 = Vtx1_ntrk10;
      ...
      fillHisto("hData_Vtx_dist","Loose",samplename, Vtx_dist1,1);
         ...
         if (systlist.Contains("Vtx"+YearCombine+"Up") && Signal)
            {
         ...
         else if (systlist.Contains("Vtx"+YearCombine+"Down") && Signal)
            {
                  int ibin0 = Vtx_nTrks0;
                  if ( ibin0 > 51 ) ibin0 = 51;
                  if ( Vtx_dist0 < 10. ) {
...
// std::cout<<"here 1 "<<std::endl;
   delete fh2DL1_ID_SF1;//
   delete fh2DL2_ID_SF1;
   delete fh2DL1_ID_SF1err;//
   delete fh2DL2_ID_SF1err;
// std::cout<<"here 2 "<<std::endl;
   delete fh2DL1_ISO_SF1;
   // std::cout<<"here 2a "<<std::endl;
   delete fh2DL2_ISO_SF1;
   // std::cout<<"here 2b "<<std::endl;
   // delete fh2DL3_ISO_SF1;
   // std::cout<<"here 2c "<<std::endl;
   delete fh2DL1_ISO_SF1err;
   // std::cout<<"here 2d "<<std::endl;
   delete fh2DL2_ISO_SF1err;
   // std::cout<<"here 2e "<<std::endl;
   // delete fh2DL3_ISO_SF1err;
   // std::cout<<"here 2f "<<std::endl;
   // delete fh2DL2_Reco_SF1err;
   // std::cout<<"here 2g "<<std::endl;
   // delete fh2DL2_Reco_SF1;
// std::cout<<"here 3 "<<std::endl;
   delete fhL1L2_TRG_SF; // x- axiss pt and y axis pt  
   delete fhL1L2_TRG_SFerr; // x- axiss pt and y axis pt 

// std::cout<<"here 4 "<<std::endl;
   delete  Weight_DOWN_00;
   delete  Weight_UP_00 ;
   delete Weight_DOWN_10;
   delete Weight_UP_10 ;
   delete  Weight_DOWN_20;
   delete  Weight_UP_20  ;
   delete  Weight_DOWN_30  ;
   delete  Weight_UP_30 ;

   //  std::cout<<"here 5 "<<std::endl;     
       // std::cout<<"File has been written: "<<theoutputfile->GetName()<<std::en
   f1_Vtx_Weight->Close();
   fL1_ID_SF->Close();
   fL1_ISO_SF->Close();
   fL2_ISO_SF->Close();
