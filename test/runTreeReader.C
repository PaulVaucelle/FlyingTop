...
//  gROOT->ProcessLine(".L TreeReader.C+");
  ...
  //   TTree* tree300_200_100=0;
  // TreeReader * tree_300_200_100 = new TreeReader(tree300_200_100, "RPV_2018_smu300_neu200_ctau100", systlist);
  // tree_300_200_100->Loop("RPV_2018_smu300_neu200_ctau100",true);
  // delete tree_300_200_100;

// "TTJets_DiLept_TuneCP5_13TeV-madgraphMLM-pythia8"
//   TString BKGSet[13]={"TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8"
