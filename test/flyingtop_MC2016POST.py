...
if year == 2016 :
    ...
    if isPostAPV :
        ...
        ROCCORPATH = "FlyingTop/FlyingTop/data/RoccoR2016aUL.txt"   # a for B_F
...
process.FlyingTop = cms.EDAnalyzer("FlyingTopAnalyzer",
                                ...
                                #    Roccor = cms.FileInPath("/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/"),
                                    ...
                                    weightFileMVA = cms.untracked.string( "BDT_TRK_240603_2016post_ctau100vsEMUdata.xml"),#track selection => previous :BDT_TRK_CTAU10cm_vs_TT.xml //BDT_TRK_ALLSIGvsDYTT_30_01_2024.xml/ BDT_TRK_ALLSIGvsALLBKG.xml // TMVAClassification_BDTG_TRKSEL_.weights.xml
