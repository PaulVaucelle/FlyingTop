...
if (Method == 3)
  {
    htitleA = "hData_CRTightLoosept_1Vtx_NEWMVA_";//
    htitleB = "hData_CRLooseLoosept_1Vtx_NEWMVA_";//
    htitleC = "hData_CRTightHighpt_1Vtx_NEWMVA_";//
    htitleD = "hData_CRLooseHighpt_1Vtx_NEWMVA_";//
