...
// Thu Mar 14 09:47:55 2024 by ROOT version 6.14/09
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8.root:/FlyingTop");
