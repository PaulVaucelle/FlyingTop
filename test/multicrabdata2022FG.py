...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = "DATA_MUMU_2022_FG_18_06_2025"
        ...
        config.Data.outLFNDirBase = '/store/user/pvaucell/DATA_MUMU_2022_FG_18_06_2025'
        ...
        inputDatasets = [
                ...
                # '/MuonEG/Run2022F-22Sep2023-v1/MINIAOD',
                # '/MuonEG/Run2022G-22Sep2023-v1/MINIAOD'
