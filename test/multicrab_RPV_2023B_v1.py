...
list_arguments = [
 ...
 ,"Msmu-500_Mchi-180_ct-003"
 ,"Msmu-500_Mchi-180_ct-010"
 ,"Msmu-300_Mchi-180_ct-030"
 ,"Msmu-500_Mchi-180_ct-030"
 ,"Msmu-450_Mchi-180_ct-100"
 ,"Msmu-400_Mchi-180_ct-300"
 ,"Msmu-450_Mchi-180_ct-1000"
]
...
#$$    sedFileZ = "sed -e 's#inputSample#" + list_arguments[i]+"#' flyingtop_temp2.py > flyingtop_temp.py"
    ...
    os.system(sedFileZ) 
    sedFile = "sed -e 's#inputSample#" + list_arguments[i]+"#' crab_config_RPV_2023B_default_v1.py > crab_config_temp.py"
    os.system(sedFile) 
