...
Int_t ColorLightBlue = color10.GetNumber();
   ...
   // DYM50
   TH1F *VtxStepEffi = new TH1F("VtxStepEffi","",3,-0.5,2.5);
   VtxStepEffi->SetBinContent(1,152.3681);
   VtxStepEffi->SetBinContent(2,0.004816726);
  //  VtxStepEffi->SetBinContent(3,0.0002001058);
   VtxStepEffi->SetBinContent(3,0.9952);
  //  VtxStepEffi->SetBinContent(5,0.1114589);
  ...
  //TTTo2L2Nu
  TH1F *VtxStepEffi2 = new TH1F("VtxStepEffi2","",3,-0.5,2.5);
     VtxStepEffi2->SetBinContent(1,13.80965);
   VtxStepEffi2->SetBinContent(2,0.0080);
  //  VtxStepEffi2->SetBinContent(3,0.0002913842);
   VtxStepEffi2->SetBinContent(3,0.9920);
  //  VtxStepEffi2->SetBinContent(5,0.1312505);
  //  VtxStepEffi2->SetEntries(2.06712e+07);

      TH1F *VtxStepEffi3 = new TH1F("VtxStepEffi3","",3,-0.5,2.5);
   VtxStepEffi3->SetBinContent(1,0.2883459);
   VtxStepEffi3->SetBinContent(2,0.8233029);
  //  VtxStepEffi->SetBinContent(3,0.01044735);
   VtxStepEffi3->SetBinContent(3,0.1761977);
  //  VtxStepEffi->SetBinContent(5,0.01605212); 

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   VtxStepEffi->SetLineColor(ColorNeutral);
   ...
   VtxStepEffi3->SetLineColor(kBlack);
   VtxStepEffi3->Scale(1./VtxStepEffi3->Integral());
   VtxStepEffi3->SetLineWidth(4.0);
...
float posX_=0;
  ...
  if( iPosX%10<=1 )
   ...
   TLegend *legend = new TLegend(0.5,0.7,0.85,0.87);
