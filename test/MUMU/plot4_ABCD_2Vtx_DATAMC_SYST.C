...
// Dmu
TFile* f1_Data_emu  = new TFile("../../DATA_MUMU_"+Year+"_19_08_2024/histofile_"+Dmode+"_OS_2p4_DoubleMuon_UL"+Year+"_MiniAODv2_NOM.root");


//Mumu
 
 TFile* f1_DY  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f2_DY  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f1_TT  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_TT  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f1_ST  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_tW_antitop_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_ST  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_tW_top_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8.root");
//  TFile* f3_ST  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_t-channel_top_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8.root");
 ...
 TFile* f1_TTV = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_ttWJetsToLNu_5f_EWK_TuneCP5_13TeV_amcatnlo-pythia8.root");
 TFile* f2_TTV = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_TTZToLL_5f_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f3_TTV = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_TTWW_TuneCP5_13TeV-madgraph-pythia8.root");
 TFile* f1_VV  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_VV  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_WZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
 TFile* f3_VV  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_ZZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
...
//signal
 TFile* f1_LLP = new TFile("../../Signal_"+Year+"_L1/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSUON[0]+"_neu"+MNEU[0]+"_ctau"+CTAU[0]+".root");
 TFile* f2_LLP = new TFile("../../Signal_"+Year+"_L1/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSUON[1]+"_neu"+MNEU[1]+"_ctau"+CTAU[1]+".root");
 TFile* f3_LLP = new TFile("../../Signal_"+Year+"_L1/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSUON[2]+"_neu"+MNEU[2]+"_ctau"+CTAU[2]+".root");
...
TString DATAFILE[1] = {"DoubleMuon_UL"+Year+"_MiniAODv2_NOM_"
};
if (Year == "2018") DATAFILE[0] = "DoubleMuon_UL2018_MiniAODv2_GT36-v1_NOM_";
...
float rwTT = 1;//0.00923001376;//0.923001376;
  ...
  if (Method == 0)
  {
    ...
    xmax =  100;
    HeaderA = "TT+TL";
    HeaderAbis = "30<pt_{i}<80 & pt_{j}>80";
    HeaderB = "LL + 30<pt<80";
    HeaderC = "TT+TL";
    HeaderCbis = "30<pt_{i}<80 & pt_{j}>80";
    HeaderD = "LL + 30<pt<80";
...
//  hsolve->SetLineWidth(2);
 ...
 hsolve->Draw("sameE2"); 
hsolve->Draw("E4same");
  hsolve->SaveAs("Tight_2Vtx_"+Plots+".root");
  c1->cd();
  pad2->cd();
  hsolve->Draw("E4same");
