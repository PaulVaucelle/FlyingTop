...
TCanvas * plot(int method, TString Prod, TString Name, TString Year, TString Dmode, bool Blind, TString Plots, bool Data, bool Mc, bool SIGNAL)
{
int stati=0;
bool fit= 1;
bool logy=1;
...
// Dmu
TFile* f1_Data_emu  = new TFile("../../DATA_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_DoubleMuon_UL"+Year+"_MiniAODv2_GT36-v1.root");


//Mumu

 TFile* f1_DY  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f2_DY  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f1_TT  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_TT  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f1_ST  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_ST_tW_antitop_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_ST  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_ST_tW_top_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8.root");
//  TFile* f3_ST  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_t-channel_top_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8.root");
//  TFile* f4_ST  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+Dmode+"_OS_2p4_ST_t-channel_antitop_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f1_TTV = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_ttWJetsToLNu_5f_EWK_TuneCP5_13TeV_amcatnlo-pythia8.root");
 TFile* f2_TTV = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_TTZToLL_5f_TuneCP5_13TeV-madgraphMLM-pythia8.root");
 TFile* f3_TTV = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_TTWW_TuneCP5_13TeV-madgraph-pythia8.root");
 TFile* f1_VV  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root");
 TFile* f2_VV  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_WZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
 TFile* f3_VV  = new TFile("../../MC_MUMU_"+Year+"_03_02_2025/histofile_"+EXTRA+Dmode+"_OS_2p4_ZZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
 

 TString MSUON[3] = {"300","300","300"};
  TString MNEU[3] = {"180","250","250"};
  TString CTAU[3] = {"100","100","300"};

//signal
 TFile* f1_LLP = new TFile("../../Signal_"+Year+"_L1/histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSUON[0]+"_neu"+MNEU[0]+"_ctau"+CTAU[0]+".root");
 TFile* f2_LLP = new TFile("../../Signal_"+Year+"_L1/histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSUON[1]+"_neu"+MNEU[1]+"_ctau"+CTAU[1]+".root");
 TFile* f3_LLP = new TFile("../../Signal_"+Year+"_L1/histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSUON[2]+"_neu"+MNEU[2]+"_ctau"+CTAU[2]+".root");

TString DATAFILE[1] = {"DoubleMuon_UL"+Year+"_MiniAODv2_"
};
if (Year == "2018") DATAFILE[0] = "DoubleMuon_UL2018_MiniAODv2_GT36-v1_";
...
// *****************************************************************************
float scaleMC = 1;// % of jobs that did not fail for emu data
 pad1->cd();
...
htotMC->SetLineColorAlpha(ColorBlue, 1);
      }
...
if (DATA)
  {
    ...
    htotData->Add(g1_Data_emu, htotData, scale, 0);
...
if ( MC) { 
 ...
 htotMCv2->SetMinimum(1); 
        htotMCv2->SetMaximum(htotMCv2->GetMaximum()*1.5); //htotMC->GetMaximum()*1
    ...
    if (MC && DATA)
      {
        ...
        htotMCv2->SetFillColorAlpha(ColorBlue, 1);
 htotMCv2->SetLineColor(ColorBlue);
 htotMCv2->SetLineColorAlpha(ColorBlue, 1);
 htotMCv2->SetMinimum(1);
...
if (Signal)
 ...
 h3_LLP->SetLineWidth(2);
  ...
  leg = new TLegend(0.5,LEGY1,0.9,LEGY2);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize2);
...
if ( !DATA)
  {
    for (int i = 0; i< nbin; i++)
      {
        double data = htotMC->GetBinContent(i);
        double pred = hsolve->GetBinContent(i);
        double sigma = hsolve->GetBinError(i);
        // std::cout<<"data = "<<data<<" pred = "<<pred<<" sigma = "<<sigma<<std::endl;
...
// *****************************************************************************
  ...
  pad5->cd();
    ...
    if ( DATA && !MC ) {
   hsolve->SetLineColor(kGray+2);//kAzure+6
   hsolve->SetFillColor(kGray+2);
 }
 else {
   hsolve->SetLineColor(kGray+2);
   hsolve->SetFillColor(kGray+2);
 }
