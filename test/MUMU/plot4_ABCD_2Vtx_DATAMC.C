...
float scaleMC = 1.;
TString ProdMC = "MC_MUMU_2018_03_02_2025";
TString ProdSignal = "Signal_2018_L1";
TString suffixDATA = "_Corr";//
TString suffixMC = "";
TString SampleDATA = "DoubleMuon_UL2018_MiniAODv2_GT36-v1";
TString SampleDATAExtra  = "DoubleMuon_UL2018_MiniAODv2_GT36-v1"+suffixDATA;
 ...
 if (Year == "2022A") 
  {
    ...
    SampleDATAExtra = "Muon_Run2022-CDE-22Sep2023"+suffixDATA;
 ...
 if (Year == "2022B") 
  {
    ...
    SampleDATAExtra = "Muon_Run2022-FG-22Sep2023"+suffixDATA;
 ...
 if (Year == "2023A") 
  {
    ...
    SampleDATAExtra = "Muon_Run2023C-22Sep2023"+suffixDATA;
 ...
 if (Year == "2023B") 
  {
    ...
    SampleDATAExtra = "Muon_Run2023D-22Sep2023"+suffixDATA;
 ...
 if (Year == "2024") 
  {
    ...
    SampleDATAExtra = "Muon_Run2024"+suffixDATA;
  }
...
// Dmu
TFile* f1_Data_emu  = new TFile("../../"+Prod+"/histofile_"+EXTRA+Dmode+"_OS_2p4_"+SampleDATAExtra+".root");
...
if (Year == "2024")
  {
    f1_DY  = new TFile("../../MC_MUMU_2023_D_23_04_2025_DY/histofile_"+EXTRA+Dmode+"_OS_2p4_DYto2L-4Jets_MLL-10to50_TuneCP5_13p6TeV_madgraphMLM-pythia8.root");
    f2_DY  = new TFile("../../MC_MUMU_2023_D_23_04_2025_DY/histofile_"+EXTRA+Dmode+"_OS_2p4_DYto2L-4Jets_MLL-50_TuneCP5_13p6TeV_madgraphMLM-pythia8.root");
  }
...
// !! ----------------- !! //
TString filename1 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSUON[2]+"_Mchi-"+MNEU[2]+"_ct-001.root";
TString filename2 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSUON[2]+"_Mchi-"+MNEU[2]+"_ct-003.root";
TString filename3 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Msmu-"+MSUON[2]+"_Mchi-"+MNEU[2]+"_ct-010.root";
if (Year == "2024") 
  {
    filename1 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-001-MChi-"+MNEU[2]+"-MSmu-"+MSUON[2]+".root";
    filename2 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-010-MChi-"+MNEU[2]+"-MSmu-"+MSUON[2]+".root";
    filename3 = "histofile_"+EXTRA+Dmode+"_OS_2p4_RPV_"+Yearcor+"_Par-ct-100-MChi-"+MNEU[2]+"-MSmu-"+MSUON[2]+".root";
  }
...
HeaderBbis = "2 hemi., p_{T}< "+HTcut+" GeV";
  ...
  if (Method == 16)
  {
    htitleA = "2Vtx_VtxVtx_EVT_MVA_tightlowlowpt_Focus";//
    htitleB = "2Vtx_VtxVtx_EVT_MVA_looselooselowlowpt_Focus";//
    htitleC = "2Vtx_VtxVtx_EVT_MVA_tighthighpt_Focus";//
    htitleD = "2Vtx_VtxVtx_EVT_MVA_looselooselowpt_Focus";//
...
//   h_TT->SetLineColorAlpha(ColorRed, 1);
//   h_TT->SetLineStyle(1);
//   h_TT->SetLineWidth(3);
...
if (DATA)
  ...
  leg = new TLegend(LEGX1,0.53,LEGX2,0.57);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  ...
  leg = new TLegend(LEGX1,0.49,LEGX2,0.53);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize);
  ...
  if (Method == 2)
    {
      leg = new TLegend(LEGX1,0.45,LEGX2,0.49);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize);
...
if(Signal)
 ...
 g1_LLP->Sumw2();
 h1_LLP = new TH1F("h1_LLP","",nbin,xmin,xmax);
 h1_LLP->Add(g1_LLP, h1_LLP, 1*scaleSignal,0);
 ...
 g2_LLP->Sumw2();
 h2_LLP = new TH1F("h2_LLP","",nbin,xmin,xmax);
 h2_LLP->Add(g2_LLP, h2_LLP, 1*scaleSignal,0);
 ...
 g3_LLP->Sumw2();
 h3_LLP = new TH1F("h3_LLP","",nbin,xmin,xmax);
 h3_LLP->Add(g3_LLP, h3_LLP, 1*scaleSignal,0);
 ...
 h3_LLP->SetLineWidth(2);
  ...
  leg = new TLegend(LEGX1-0.1,LEGY1,LEGX2-0.1,LEGY2);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize2);
...
// leg->AddEntry(h1_LLP," m_{#tilde{#mu} (#tilde{#chi}^{0})} = 250 (200) GeV","L");
  ...
  if (Signal)
    {
      if (scaleSignal > 1)
        {
          leg->AddEntry(h1_LLP," m_{#tilde{#mu} (#tilde{#chi}^{0})} = "+MSUON[0]+" ("+MNEU[0]+") GeV "+CTAU[0]+" mm (x"+scaleSignal+")","L");
          leg->AddEntry(h2_LLP," m_{#tilde{#mu} (#tilde{#chi}^{0})} = "+MSUON[1]+" ("+MNEU[1]+") GeV "+CTAU[1]+" mm (x"+scaleSignal+")","L");
          leg->AddEntry(h3_LLP," m_{#tilde{#mu} (#tilde{#chi}^{0})} = "+MSUON[2]+" ("+MNEU[2]+") GeV "+CTAU[2]+" mm (x"+scaleSignal+")","L");
        }
      else 
        {
          leg->AddEntry(h1_LLP," m_{#tilde{#mu} (#tilde{#chi}^{0})} = "+MSUON[0]+" ("+MNEU[0]+") GeV "+CTAU[0]+" mm","L");
  ...
  leg = new TLegend(LEGX1-0.1,0.53,LEGX2-0.1,0.57);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize);
  ...
  leg = new TLegend(LEGX1-0.1,0.49,LEGX2-0.1,0.53);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize);
  ...
  if (Method == 2)
    {
      leg = new TLegend(LEGX1-0.1,0.45,LEGX2-0.1,0.49);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize);
...
//   leg->AddEntry(h4_LLP,"Signal, m_{#tilde{#mu}}= 500 GeV, m_{#tilde{#chi}^{0}}= 350 GeV","L");
  ...
  leg = new TLegend(0.175,0.82,0.35,0.87);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize);
  ...
  leg = new TLegend(0.175,0.77,0.35,0.81);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize);
  ...
  if (Method == 2)
    {
      leg = new TLegend(0.175,0.71,0.35,0.76);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(legsize);
...
std::cout<<"MUMU 2 vertices : "<<SumDataEvent<<std::endl;
