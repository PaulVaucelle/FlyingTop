...
config.JobType.psetName = 'flyingtop_default_MC2022B.py'
...
#$$$$ 
                ...
                'Summer22EE_22Sep2023_V2_MC_Uncertainty_AK4PFchs.txt' #Summer22EE_22Sep2023_RunF_V2_DATA_Uncertainty_AK4PFchs.txt
