...
// Tue Apr 23 17:44:55 2024 by ROOT version 6.14/09
// from TTree T/summary information
// found on file: MiniRPV_2018_smu500_neu350_ctau100.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MiniRPV_2018_smu500_neu350_ctau100.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MiniRPV_2018_smu500_neu350_ctau100.root");
      }
      f->GetObject("T",tree);
