...
void ToysFit() 
{
  ...
  // HTL_VtxBDT_Ave_Corr done
  // HTL_EventBDT_Corr
  // HTL_STW_6Bins_Corr done

  TString Var = "HTL_EventBDT_Corr"; // diffBin_EvtBDT ; HTL_VtxBDT_Ave_Corr
  TString Year= "2016PRE"; // Year : "2016PRE", "2016POST", "2017", "2018"
...
// ABCDReader/MUMU/2018/ABCD_MUMU__HTL_VtxBDT_Ave_Corr_Data_2018.root
// ABCDReader/MUMU/2018/ABCD__HTL_VtxBDT_Ave_Corr_Data_2018.root

  TString path = "/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/ABCDReader/"+Channel+"/"+Year+"/"; // Chemin vers le fichier d'entrée
  bool SpecificFit = true; // Si true, utilise un fit spécifique, sinon fit exponentiel décroissant par défaut
...
// 		double 	mean = 0 )
...
else if (UltraSpecificFit)
  {
...
else
    {
      ...
      // expoFit->SetParLimits(0, 100, 200); // Amplitude >= 0
      // expoFit->SetParLimits(1, 0.000001, 100); // Amplitude >= 0
    }
