...
// !! new Vertex BDT 
   ...
   TString BDT_VTX_Name = "BDT_2VTX_18_06_2025_TrainingvF_ctau100.xml";
   TString BDT_EVT2VTX_Name = "BDT_2VTX_18_06_2025_TrainingvF_ctau100.xml";

   if (Year == 2018)
      {
         BDT_VTX_Name = "BDT_2VTX_18_06_2025_TrainingvF_ctau100.xml";
         BDT_EVT2VTX_Name = "BDT_EVT2VTX_18_06_2025_TrainingvF_ctau100_NoStep.xml";
      }
   else if (Year == 2017)
      {
        BDT_VTX_Name = "BDT_2VTX_2017_11_10_2025_TrainingvF_ctau100.xml";
        BDT_EVT2VTX_Name = "BDT_EVT2VTX_2017_11_10_2025_TrainingvF_ctau100.xml";
      }
   else if (Year == 2016)
      {
         if (isPostAPV)
            {
               BDT_VTX_Name = "BDT_2VTX_2016POST_11_10_2025_TrainingvF_ctau100.xml";
               BDT_EVT2VTX_Name = "BDT_EVT2VTX_2016POST_11_10_2025_TrainingvF_ctau100.xml";
            }
         else
            {
               BDT_VTX_Name = "BDT_2VTX_2016PRE_11_10_2025_TrainingvF_ctau100.xml";
               BDT_EVT2VTX_Name = "BDT_EVT2VTX_2016PRE_11_10_2025_TrainingvF_ctau100.xml";
            }
      }
   readerVtx->BookMVA( "BDTG", "/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/"+BDT_VTX_Name); // root 6.14/09, care compatiblity of versions for tmva
...
readerVtx_EVT->AddVariable( "mva_Vtx2_NChi2",   &mva_V2_chi);
   ...
   readerVtx_EVT->BookMVA( "BDTG", "/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/"+BDT_EVT2VTX_Name); // root 6.14/09, care compatiblity of versions for tmva
...
TH2F *fh2DL2_Reco_SF1err;
         ...
         if(Year == 2016)
            {
               if (isPostAPV){
                  ...
                  fL2_Reco_SF =  new TFile("../../Scale_factors/Muon/Efficiency_muon_generalTracks_Run2016postVFP_UL_trackerMuon.root");
               ...
               // histos associated to files
                  ...
                  fL2_Reco_SF =  new TFile("../../Scale_factors/Muon/Efficiency_muon_generalTracks_Run2016preVFP_UL_trackerMuon.root");
                  fL2_ID_SF= new TFile("../../Scale_factors/Muon/Run2016_UL/NUM_TightID_DEN_TrackerMuons/NUM_TightID_DEN_TrackerMuons_abseta_pt.root");
                  fL2_ISO_SF= new TFile("../../Scale_factors/Muon/Run2016_UL/NUM_MiniIsoTight_DEN_TightID/NUM_MiniIsoTight_DEN_TightID_abseta_pt.root");
   ...
   // !! End Normalisation 
   TString YearCombine = "2018";
   TString Yearcor = "2018";
   TString YearDaniel = "2018";

   if (Year == 2016 && !isPostAPV) 
   {
      Yearcor = "2016PRE";
      YearDaniel = "2016";
      YearCombine = "2016preVFP";
   }
   if (Year == 2016 && isPostAPV) 
   {
      Yearcor = "2016POST";
   ...
   if ( Signal )// 
      {
         ...
         TString SmuonPattern = "smu";
         TString NeuPattern = "neu";
         TString CtauPattern = "ctau";
         ...
         if (Ctaupos != kNPOS) {
            ...
            if (thesample.Contains("ctau1000")) {
...
// !! §§ !! ;; 
      ...
      TFile*   f_Cor_Correlation = new TFile("/opt/sbg/cms/ui2_data1/pvaucell/CMSSW_10_6_30_FLY/src/FlyingTop/FlyingTop/test/ABCDReader/Signal/"+Yearcor+"/VtxQuality_Hemipt_2Vtx_MUMU_MC_"+Yearcor+".root");
      // if (!isMC)
      //    {
