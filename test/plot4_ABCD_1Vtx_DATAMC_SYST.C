...
//signal
 ...
 TFile* f2_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau003.root");
 TFile* f3_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau010.root");
 TFile* f4_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau030.root");
 TFile* f5_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau100.root");
 TFile* f6_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau300.root");
 TFile* f7_LLP = new TFile("../../"+Prod+"/histofile_"+Dmode+"_OS_2p4_RPV_"+Yearcor+"_smu"+MSmuon+"_neu"+MNeu+"_ctau1000.root");
...
std::vector<TFile*> f_SYST_Up;
 std::vector<TFile*> f_SYST_Down;
  ...
  if (WGen)
    {
      ...
      SYSTNAME_UP.push_back("XS");
      SYSTNAME_DOWN.push_back("XS");
    }
  if (WLepton)
    {
  ...
  // TFile* f_PDFUp  = new TFile("./SYST/PDFUp_SYST.root");
    TFile* f_XSUp  = new TFile("./SYST/XSUp_SYST.root");
  ...
  TFile* f_XSDown  = new TFile("./SYST/XSDown_SYST.root");
...
if (WGen)
  {
    // f_SYST_Down.push_back(f_PDFDown);
    f_SYST_Down.push_back(f_XSDown);
    // f_SYST_Down.push_back(f_ScaleDown);
  }
if (WLepton)
  {
