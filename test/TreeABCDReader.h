...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TreeABCDReader(TTree *tree=0,TString Prod ="", TString sample="", std::vector<TString> thesystlist = std::vector<TString>());
   virtual ~TreeABCDReader();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(bool isMC, TString Prod,TString sample, bool Signal, bool SS, bool FWD, int Year, float mean, bool DoubleMuon, int mixing,  int Channel,bool isPostAPV);
...
TreeABCDReader::TreeABCDReader(TTree *tree, TString Prod , TString sample, std::vector<TString> thesystlist) : fChain(0) 
{
