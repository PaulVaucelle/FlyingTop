...
//  gROOT->ProcessLine(".L TreeABCDReader.C+");
  ...
  // systlist.push_back("");
  // systlist.push_back("Lumi2016Up");
  // systlist.push_back("Lumi2016Down");
  // systlist.push_back("L12016Up");
  // systlist.push_back("L12016Down");
  // systlist.push_back("Trigger2016Down");
  // systlist.push_back("Trigger2016Up");
  // systlist.push_back("MuonID2016Up");
  // systlist.push_back("MuonID2016Down");
  // systlist.push_back("MuonISO2016Up");
  // systlist.push_back("MuonISO2016Down");
  // systlist.push_back("PU2016Up");
  // systlist.push_back("PU2016Down");
  systlist.push_back("JEC2016Up");
  systlist.push_back("JEC2016Down");
  systlist.push_back("JER2016Up");
  systlist.push_back("JER2016Down");
  // systlist.push_back("Vtx2016Up");
  // systlist.push_back("Vtx2016Down");
  ...
  // systlist.push_back("TopPtDown");
    ...
    int YEAR = 2016;
  TString Year = "2016";
  TString Prod = "Signal_2016POST"; //DATAMC2018_EMU_10_06_2024 //  EMU: SYST_EMU_CTAU100/Prod100_EMU_JER_up !! M: SYST_CTAU100/Prod100_JER_up // BKG MC and Data PROD_ANNIVERSAIRE_2024
  bool isPostAPV = true;
  bool Signal = true;
  bool SameSign = false;
  bool Forward = false; 
...
//         {
//             Prod = "Signal_2016POST";
//             if (systlist.size() == 0) return;
//             else if (systlist[j] == "JEC2016Up")
//               {
//                 Prod = "Signal_2016POST_JECUp";
//               }
//             else if (systlist[j] == "JEC2016Down")
//               {
//                 Prod = "Signal_2016POST_JECDown";
//               }
//             else if (systlist[j] == "JER2016Up")
//               {
//                 Prod = "Signal_2016POST_JERUp";
//               }
//             else if (systlist[j] == "JER2016Down")
//               {
//                 Prod = "Signal_2016POST_JERDown";
//               }
//             else
//               {
//                 Prod = "Signal_2016POST";
...
// //  problem avec 20
//  for (int i = 0 ; i< 34 ; i++) //19-20    12 -13
//      {
// for (unsigned int j = 0 ; j < systlist.size(); j++)
//         {
//                 Prod = "Signal_2016POST";
