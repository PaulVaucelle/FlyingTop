...
void plot_XSLL_KFactor_AN() {
    ...
    std::vector<double> y3 = {21.81, 9.21, 4.43, 2.33, 1.31, 0.77, 0.47}; // NLO+NLL B.Fucks
    std::vector<double> y4 = {18.84, 8.04, 3.89, 2.05, 1.15, 0.68, 0.42}; // LO B.Fucks
    ...
    std::vector<double> y3_PDF_up_percent = {0.4,0.4,0.3,0.3,0.3,0.3,0.4};// NLO+NLL B.Fucks
    std::vector<double> y3_PDF_down_percent = {4.4,5.0,5.4,5.9,6.5,6.8,7.1};// NLO+NLL B.Fucks
    std::vector<double> y4_PDF_up_percent = {0,0,0,0,0,0,0};// LO B.Fucks : no pdf variation provided
    std::vector<double> y4_PDF_down_percent = {0,0,0,0,0,0,0};// LO B.Fucks: no pdf variation provided
