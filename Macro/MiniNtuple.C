...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   std::vector<float> minitree_reco_muon_leadingpt ;
   std::vector<float> minitree_reco_electron_leadingpt2 ;
   std::vector<float> minitree_reco_muon_leadingeta ;
   std::vector<float> minitree_reco_electron_leadingeta2 ;
   std::vector<float> minitree_reco_muon_leadingphi ;
   std::vector<float> minitree_reco_electron_leadingphi2 ;

   std::vector<float> minitree_trig_muon_leadingpt ;
   std::vector<float> minitree_trig_electron_leadingpt2 ;
   std::vector<float> minitree_trig_muon_leadingeta ;
   std::vector<float> minitree_trig_electron_leadingeta2 ;
   std::vector<float> minitree_trig_muon_leadingphi ;
   std::vector<float> minitree_trig_electron_leadingphi2 ;
   ...
   std::vector<float> minitree_trig_lepton_leadingpt ;
   std::vector<float> minitree_trig_lepton_leadingpt2 ;
   std::vector<float> minitree_trig_lepton_leadingeta ;
   std::vector<float> minitree_trig_lepton_leadingeta2 ;
   std::vector<float> minitree_trig_lepton_leadingphi ;
   std::vector<float> minitree_trig_lepton_leadingphi2 ;
   ...
   smalltree->Branch("minitree_reco_muon_leadingpt",&minitree_reco_muon_leadingpt);
   smalltree->Branch("minitree_reco_electron_leadingpt2",&minitree_reco_electron_leadingpt2);
   smalltree->Branch("minitree_reco_muon_leadingeta",&minitree_reco_muon_leadingeta);
   smalltree->Branch("minitree_reco_electron_leadingeta2",&minitree_reco_electron_leadingeta2);
   smalltree->Branch("minitree_reco_muon_leadingphi",&minitree_reco_muon_leadingphi);
   smalltree->Branch("minitree_reco_electron_leadingphi2",&minitree_reco_electron_leadingphi2);

   smalltree->Branch("minitree_trig_muon_leadingpt",&minitree_trig_muon_leadingpt);
   smalltree->Branch("minitree_trig_electron_leadingpt2",&minitree_trig_electron_leadingpt2);
   smalltree->Branch("minitree_trig_muon_leadingeta",&minitree_trig_muon_leadingeta);
   smalltree->Branch("minitree_trig_electron_leadingeta2",&minitree_trig_electron_leadingeta2);
   smalltree->Branch("minitree_trig_muon_leadingphi",&minitree_trig_muon_leadingphi);
   smalltree->Branch("minitree_trig_electron_leadingphi2",&minitree_trig_electron_leadingphi2);
   ...
   smalltree->Branch("minitree_trig_lepton_leadingpt",&minitree_trig_lepton_leadingpt);
   smalltree->Branch("minitree_trig_lepton_leadingpt2",&minitree_trig_lepton_leadingpt2);
   smalltree->Branch("minitree_trig_lepton_leadingeta",&minitree_trig_lepton_leadingeta);
   smalltree->Branch("minitree_trig_lepton_leadingeta2",&minitree_trig_lepton_leadingeta2);
   smalltree->Branch("minitree_trig_lepton_leadingphi",&minitree_trig_lepton_leadingphi);
   smalltree->Branch("minitree_trig_lepton_leadingphi2",&minitree_trig_lepton_leadingphi2);
   ...
   for (Long64_t jentry=0; jentry<nentries; jentry++) {
      ...
      if (tree_ll_pt->size()>0 && (tree_Mmumu >10 && tree_Good_PV)  && ((tree_nmu>0 && tree_electron_nEle>0) || (tree_nmu>1 || tree_electron_nEle>1)))
         {
      ...
      if (tree_reco_muon_leadingpt->size()>0)
         {if (debug)  {std::cout<<"electron muon  "<<std::endl;}
            minitree_reco_muon_leadingpt.push_back(tree_reco_muon_leadingpt->at(0));
            minitree_reco_electron_leadingpt2.push_back(tree_reco_electron_leadingpt2->at(0));
            minitree_reco_muon_leadingeta.push_back(tree_reco_muon_leadingeta->at(0));
            minitree_reco_electron_leadingeta2.push_back(tree_reco_electron_leadingeta2->at(0));
            minitree_reco_muon_leadingphi.push_back(tree_reco_muon_leadingphi->at(0));
            minitree_reco_electron_leadingphi2.push_back(tree_reco_electron_leadingphi2->at(0));
            if (tree_only_tigger_filter)
               {
                  minitree_trig_muon_leadingpt.push_back(tree_trig_muon_leadingpt->at(0));
                  minitree_trig_electron_leadingpt2.push_back(tree_trig_electron_leadingpt2->at(0));
                  minitree_trig_muon_leadingeta.push_back(tree_trig_muon_leadingeta->at(0));
                  minitree_trig_electron_leadingeta2.push_back(tree_trig_electron_leadingeta2->at(0));
                  minitree_trig_muon_leadingphi.push_back(tree_trig_muon_leadingphi->at(0));
                  minitree_trig_electron_leadingphi2.push_back(tree_trig_electron_leadingphi2->at(0));
               }
         }

      if (tree_reco_lepton_leadingpt->size()>0)
         {
            if (debug)  {std::cout<<"lepton  "<<std::endl;}
            ...
            if (tree_only_tigger_filter)
               {
                  minitree_trig_lepton_leadingpt.push_back(tree_trig_lepton_leadingpt->at(0));
                  minitree_trig_lepton_leadingpt2.push_back(tree_trig_lepton_leadingpt2->at(0));
                  minitree_trig_lepton_leadingeta.push_back(tree_trig_lepton_leadingeta->at(0));
                  minitree_trig_lepton_leadingeta2.push_back(tree_trig_lepton_leadingeta2->at(0));
                  minitree_trig_lepton_leadingphi.push_back(tree_trig_lepton_leadingphi->at(0));
                  minitree_trig_lepton_leadingphi2.push_back(tree_trig_lepton_leadingphi2->at(0));
               }
         }
      ...
      minitree_reco_muon_leadingpt.clear();
      minitree_reco_electron_leadingpt2.clear();
      minitree_reco_muon_leadingeta.clear();
      minitree_reco_electron_leadingeta2.clear();
      minitree_reco_muon_leadingphi.clear();
      minitree_reco_electron_leadingphi2.clear();

      minitree_trig_muon_leadingpt.clear();
      minitree_trig_electron_leadingpt2.clear();
      minitree_trig_muon_leadingeta.clear();
      minitree_trig_electron_leadingeta2.clear();
      minitree_trig_muon_leadingphi.clear();
      minitree_trig_electron_leadingphi2.clear();
      ...
      minitree_trig_lepton_leadingpt.clear();
      minitree_trig_lepton_leadingpt2.clear();
      minitree_trig_lepton_leadingeta.clear();
      minitree_trig_lepton_leadingeta2.clear();
      minitree_trig_lepton_leadingphi.clear();
      minitree_trig_lepton_leadingphi2.clear();
