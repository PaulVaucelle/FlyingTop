...
// Mon Jun 24 14:10:19 2024 by ROOT version 5.34/36
// from TTree ttree/ttree
// found on file: RPV_2018_smu500_neu450_ctau030.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<float>   *tree_reco_muon_leadingpt;
   vector<float>   *tree_reco_electron_leadingpt2;
   vector<float>   *tree_reco_muon_leadingeta;
   vector<float>   *tree_reco_electron_leadingeta2;
   vector<float>   *tree_reco_muon_leadingphi;
   vector<float>   *tree_reco_electron_leadingphi2;
   vector<float>   *tree_trig_muon_leadingpt;
   vector<float>   *tree_trig_electron_leadingpt2;
   vector<float>   *tree_trig_muon_leadingeta;
   vector<float>   *tree_trig_electron_leadingeta2;
   vector<float>   *tree_trig_muon_leadingphi;
   vector<float>   *tree_trig_electron_leadingphi2;
   vector<float>   *tree_reco_lepton_leadingpt;
   vector<float>   *tree_reco_lepton_leadingpt2;
   vector<float>   *tree_reco_lepton_leadingeta;
   vector<float>   *tree_reco_lepton_leadingeta2;
   vector<float>   *tree_reco_lepton_leadingphi;
   vector<float>   *tree_reco_lepton_leadingphi2;
   vector<float>   *tree_trig_lepton_leadingpt;
   vector<float>   *tree_trig_lepton_leadingpt2;
   vector<float>   *tree_trig_lepton_leadingeta;
   vector<float>   *tree_trig_lepton_leadingeta2;
   vector<float>   *tree_trig_lepton_leadingphi;
   vector<float>   *tree_trig_lepton_leadingphi2;
...
#ifdef TrackAna_cxx
TrackAna::TrackAna(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("RPV_2018_smu500_neu450_ctau030.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("RPV_2018_smu500_neu450_ctau030.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("RPV_2018_smu500_neu450_ctau030.root:/FlyingTop");
...
Int_t TrackAna::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TrackAna::LoadTree(Long64_t entry)
{
...
void TrackAna::Show(Long64_t entry)
{
...
Int_t TrackAna::Cut(Long64_t entry)
{
