...
//     hmaxBD = 1E9;
  ...
  //ABCD_EMu2018A 094
  // ABCD_2018A 095
 TFile* f1_Data_emu  = new TFile("../"+Prod+"/ABCD_2018A.root");
 TFile* f2_Data_emu  = new TFile("../"+Prod+"/ABCD_2018B.root");
 TFile* f3_Data_emu  = new TFile("../"+Prod+"/ABCD_2018C.root");
 TFile* f4_Data_emu  = new TFile("../"+Prod+"/ABCD_2018D.root");
 TFile* f1_LLP = new TFile("../23_04_2024/ABCD_RPV_2018_smu250_neu200_ctau100.root");
 TFile* f2_LLP = new TFile("../23_04_2024/ABCD_RPV_2018_smu300_neu250_ctau100.root");
 TFile* f3_LLP = new TFile("../23_04_2024/ABCD_RPV_2018_smu400_neu300_ctau100.root");
 TFile* f4_LLP = new TFile("../23_04_2024/ABCD_RPV_2018_smu500_neu350_ctau100.root");

//  TFile* f1_DY  = new TFile("../outputMini/240423/h_DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
//  TFile* f2_DY  = new TFile("../outputMini/240423/h_DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8.root");
//  TFile* f1_TT  = new TFile("../outputMini/240423/h_TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root");
//  TFile* f2_TT  = new TFile("../outputMini/240423/h_TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8.root");
//  TFile* f1_ST  = new TFile("../outputMini/240423/h_ST_tW_antitop_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8.root");
//  TFile* f2_ST  = new TFile("../outputMini/240423/h_ST_tW_top_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8.root");
//  TFile* f1_TTV = new TFile("../outputMini/240423/h_ttWJetsToLNu_5f_EWK_TuneCP5_13TeV_amcatnlo-pythia8.root");
//  TFile* f2_TTV = new TFile("../outputMini/240423/h_TTZToLL_5f_TuneCP5_13TeV-madgraphMLM-pythia8.root");
//  TFile* f3_TTV = new TFile("../outputMini/240423/h_TTWW_TuneCP5_13TeV-madgraph-pythia8.root");
//  TFile* f1_VV  = new TFile("../outputMini/240423/h_WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root");
//  TFile* f2_VV  = new TFile("../outputMini/240423/h_WZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
//  TFile* f3_VV  = new TFile("../outputMini/240423/h_ZZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
//  TFile* f1_LLP = new TFile("../outputMini/240423/h_RPV_2018_smu250_neu200_ctau100.root");
//  TFile* f2_LLP = new TFile("../outputMini/240423/h_RPV_2018_smu300_neu250_ctau100.root");
//  TFile* f3_LLP = new TFile("../outputMini/240423/h_RPV_2018_smu400_neu300_ctau100.root");
//  TFile* f4_LLP = new TFile("../outputMini/240423/h_RPV_2018_smu500_neu350_ctau100.root");
...
if ( !DATA ) {
 ...
 g1_TVV = (TH1F*)gROOT->FindObject(htitleA);
 e2_TVV = (TH1F*)gROOT->FindObject("hData_Filter");
 g2_TVV = (TH1F*)gROOT->FindObject(htitleA);
 e3_TVV = (TH1F*)gROOT->FindObject("hData_Filter");
 g3_TVV = (TH1F*)gROOT->FindObject(htitleA);
  h_TVV = new TH1F("h_TVV","",nbin,xmin,xmax);
 ...
 e1_TTV = (TH1F*)gROOT->FindObject("hData_Filter");
 g1_TTV = (TH1F*)gROOT->FindObject(htitleA);
 e2_TTV = (TH1F*)gROOT->FindObject("hData_Filter");
 g2_TTV = (TH1F*)gROOT->FindObject(htitleA);
 e3_TTV = (TH1F*)gROOT->FindObject("hData_Filter");
...
if ( DATA ) { 
  leg->SetHeader("2018                              60 fb^{-1} (13 TeV)");
}
else { 
...
if ( DATA ) { 
  leg = new TLegend(0.54,0.70,0.85,0.89);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->SetTextFont(42);
  leg->SetTextSize(0.035);
  leg->SetMargin(0.2);
  leg->AddEntry(htot, " e#mu data","F");
